...
void main() {
  runApp(const rivas_senderismo());
}

class rivas_senderismo extends StatelessWidget {
  const rivas_senderismo({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Cerro de la Cruz',
      'Una caminata moderada hasta el Cerro de la Cruz te recompensa con vistas panorámicas de la ciudad de Rivas, el Volcán San Cristóbal y el Volcán Mombacho. Disfruta del aire puro, la flora y fauna local y toma fotos memorables.',
      'Abierto todos los días. Se recomienda iniciar la caminata temprano por la mañana.',
      'Entrada gratuita.',
      0,
      'A 5 km de Rivas, Rivas, Nicaragua.',
      'Moderado.',
      'Aproximadamente 3 horas de ida y vuelta.',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cerro de la Cruz', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/sM4ReNVDFtniAZZZ8';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/rivas6.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
