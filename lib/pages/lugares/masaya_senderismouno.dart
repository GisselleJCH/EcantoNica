...
void main() {
  runApp(const masaya_senderismouno());
}

class masaya_senderismouno extends StatelessWidget {
  const masaya_senderismouno({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      'Lunes a Domingo , 09:00am-08:00pm',
      'Entrada diruna: Extranjeros - 100 Córdobas. Nicaragüenses - 30 Córdobas. Entrada noctuna: 10 Córdobas por persona.',
      25281444,
      'Km 23, Carretera a Masaya',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Nacional Volcán Masaya', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://www.google.com/maps/@11.994722,-86.175378,13z?hl=es-ES&entry=ttu';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/masaya5.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
