...
void main() {
  runApp(const matagalpa_parquedos());
}

class matagalpa_parquedos extends StatelessWidget {
  const matagalpa_parquedos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Parque Los Monos',
      'Un parque con áreas verdes, juegos infantiles y un kiosko para eventos. Ideal para pasar un día en familia o hacer un picnic.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Los Monos', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/McgKNPM6TdDu2Wbg6';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/ma5.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
