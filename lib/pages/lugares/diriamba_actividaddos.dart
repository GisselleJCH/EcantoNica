...
void main() {
  runApp(const diriamba_actividaddos());
}

class diriamba_actividaddos extends StatelessWidget {
  const diriamba_actividaddos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Reserva Concepción de Maria',
      'Un área protegida con una rica biodiversidad, ideal para realizar senderismo, observación de flora y fauna y camping.',
      'Abre de lunes a sábado de 9:00am a 04:00pm, y domingo cerrado.',
      '',
      78338469,
      'Ubicado en escuela de manejo 300, metros al norte, Nicaragua. ',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Reserva Concepción de Maria', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.google.com/?cid=15198818708281916621';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/diriamba4.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
