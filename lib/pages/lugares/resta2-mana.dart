...
void main() {
  runApp(const resmana2());
}

class resmana2 extends StatelessWidget {
  const resmana2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Tiene menú para niños y adultos para todas la edades dispuestos a servir a nuestro clientes',
      'Abre hasta las 9 y cierra a las 8pm',
      'Rango de precios bajo a medio.',
      22666313,
      '18 y 19 Ave. Sur Oeste, Managua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Restaurante El Eskimo', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/kWtMaGMjV8wvicCJA';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/rma2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
