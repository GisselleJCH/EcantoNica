...
void main() {
  runApp(const diriamba_senderismo());
}

class diriamba_senderismo extends StatelessWidget {
  const diriamba_senderismo({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Cascada las mercedes',
      'La Cascada Las Mercedes es un lugar natural y mágico para disfrutar del aire puro en familia.',
      'Abierto de Lunes a Domingo.',
      '',
      0,
      'Se encuentra ubicado entre las zonas verdes de la comunidad Las Mercedes, sobre la carretera a San Gregorio en Diriamba',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cascada las mercedes', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/BFe4KwYDiFWangfj7';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/diriamba7.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
