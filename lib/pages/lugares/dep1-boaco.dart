...
class deboa1 extends StatelessWidget {
  const deboa1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      'Varía según el evento deportivo',
      0,
      'Barrio El Recreo, Boaco, Nicaragua.',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Estadio Municipal de Boaco', negocio: negocio),
    );
  }
}
