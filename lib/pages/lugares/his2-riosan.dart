...
void main() {
  runApp(const hriosan2());
}

class hriosan2 extends StatelessWidget {
  const hriosan2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un fuerte colonial construido en el siglo XVII, que sirvió como defensa contra los piratas y los ataques ingleses. Recorre sus murallas, conoce su historia y disfruta de las vistas panorámicas del río San Juan.',
      'Abierto todos los días de 8:00 a 17:00 horas.',
      'Entrada: US 2.',
      0,
      'A 15 km de San Carlos, El Castillo, Río San Juan, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Fuerte El Castillo', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/hriosan2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
