...
class rboac1 extends StatelessWidget {
  const rboac1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un restaurante familiar que sirve platos típicos nicaragüenses en un ambiente acogedor y hogareño. Disfruta de un delicioso nacatamal, un plato de gallo pinto o un rico vigorón.',
      'Abierto de lunes a domingo de 7:00 a 22:00 horas.',
      'Rango de precios bajo.',
      53723456,
      'Contiguo al parque central de Boaco, Boaco, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Restaurante Doña Julia', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/rgctmPzCu7ADdDxj9 ';
 @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
