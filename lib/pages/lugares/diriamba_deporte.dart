...
void main() {
  runApp(const diriamba_deporte());
}

class diriamba_deporte extends StatelessWidget {
  const diriamba_deporte({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Campo Santa Cecilia',
      'El campo Santa Cecilia, patrimonio de la ciudad de Diriamba, una de las principales plataformas para la práctica del fútbol en nuestro municipio  y escenario histórico, donde se jugaron innumerables clásicos entre el Cacique Diriangén FC y el CD Santa Cecilia.',
      'Abre de lunes a Domingo, 09:00am-09:30pm',
      '',
      0,
      'Ubicado Diriamba, Nicaragua. ',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Campo Santa Cecilia', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/Sc4gBUn44LKizemn9';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/diriamba8.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
