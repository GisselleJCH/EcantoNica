...
void main() {
  runApp(const resnuevasego2());
}

class resnuevasego2 extends StatelessWidget {
  const resnuevasego2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un restaurante elegante que ofrece cocina nicaragüense e internacional en un ambiente moderno y sofisticado. Ideal para una cena especial o una ocasión romántica.',
      'Abierto de martes a domingo de 12:00 a 15:00 y de 18:00 a 22:00 horas. Cerrado los lunes.',
      'Rango de precios alto.',
      73726789,
      'Barrio San Juan, Ocotal, Nueva Segovia, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Restaurante La Casona Segoviana', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/jLy22kM1Ffo9Vcrh9 ';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/re2sego.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
