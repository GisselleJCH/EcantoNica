...
void main() {
  runApp(const actcjino1());
}

class actcjino1 extends StatelessWidget {
  const actcjino1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'La Reserva Natural Duna de Olomega alberga una gran variedad de flora y fauna, incluyendo bosques nubosos, cascadas y miradores con vistas panorámicas. Disfruta de senderismo, observación de aves, ciclismo y otras actividades al aire libre.',
      'Abierto todos los días.',
      'Entrada: US 5.',
      0,
      'A 20 km de Jinotega, Jinotega, Nicaragua.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Reserva Natural Duna de Olomega', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/Nfp84VpMmqeG84Cn7 ';
  @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/actijino1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
