...
void main() {
  runApp(const leon_historia());
}

class leon_historia extends StatelessWidget {
  const leon_historia({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'La catedral de León de Nicaragua',
      'La Insigne y Real Basílica Catedral de la Asunción de la Bienaventurada Virgen María denominada popularmente como la Catedral de León es el monumento más conocido y característico de la ciudad de León.',
      'Lunes a Domingo. 8am-12pm;2:30pm-5pm',
      'Gratis.',
      0,
      'Calle Rubén Darìo, Av. Central Nte., León',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'La catedral de León de Nicaragua', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/TWr9svbH5zw2nvLt7';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/leon8.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
