...
void main() {
  runApp(const act2boaco());
}

class act2boaco extends StatelessWidget {
  const act2boaco({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Laguna de Tecomapote', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/v1aWevhqbqbnDmNDA ';
   @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/re2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
