...
void main() {
  runApp(const dep2jino());
}

class dep2jino extends StatelessWidget {
  const dep2jino({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      0,
      'Barrio San Juan, Jinotega, Nicaragua.',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Complejo Deportivo Alejandro León', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/depo2jino.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
