...
void main() {
  runApp(const deeste1());
}

class deeste1 extends StatelessWidget {
  const deeste1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      'Varía según el evento deportivo',
      0,
      'Barrio El Recreo, Estelí, Nicaragua',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Estadio Norberto Herrera', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/de1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
