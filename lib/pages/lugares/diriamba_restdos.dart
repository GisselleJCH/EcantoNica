...
void main() {
  runApp(const diriamba_restdos());
}

class diriamba_restdos extends StatelessWidget {
  const diriamba_restdos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Ciscos Bar',
      'Un bar con un ambiente animado y una amplia selección de bebidas',
      'Abre de martes a sábado de 5:00 a 24:00, y domingo de 17:00 a 24:00. Lunes cerrado.',
      '',
      78692278,
      'Ubicado en Reloj Publico de Diriamba 4 Cuadras 1/2 Al Oeste., Diriamba, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Ciscos Bar', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/diriamba2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
