...
class sego2 extends StatelessWidget {
  const sego2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'La Laguna de Jalapa es un lago de origen volcánico rodeado de un paisaje montañoso. Un sendero te lleva a la orilla de la laguna, donde puedes disfrutar de un paseo en bote, observar aves exóticas y relajarte en un entorno natural único.',
      'Abierto todos los días. Se recomienda llegar temprano en la mañana o al final de la tarde para evitar el calor del sol.',
      'Entrada: US 3.',
      71726789,
      'A 15 km de Ocotal, Ocotal, Nueva Segovia, Nicaragua.',
      'Fácil',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Laguna de Jalapa', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/3vdhfiWtxKep2fEK7 ';
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/sego2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
