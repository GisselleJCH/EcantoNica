...
void main() {
  runApp(const his1ccn());
}

class his1ccn extends StatelessWidget {
  const his1ccn({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un museo que alberga una colección de piezas arqueológicas, objetos históricos y culturales de la región. Aprende sobre la historia, tradiciones y costumbres de la Costa Caribe Norte.',
      'Abierto de martes a domingo de 8:00 a 12:00 y de 13:00 a 17:00 horas. Cerrado los lunes.',
      'Entrada: US 2.',
      0,
      'Centro de la ciudad de Bilwi, Puerto Cabezas, Costa Caribe Norte, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Museo Regional de Puerto Cabezas', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/npkLVQ63myLAiGzr5 ';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/hccn1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
