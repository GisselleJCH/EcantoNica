...
class pccn1 extends StatelessWidget {
  const pccn1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Central de Bilwi', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/io1wkZ3RxKVhxXqN9 ';
  @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/pccn1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
