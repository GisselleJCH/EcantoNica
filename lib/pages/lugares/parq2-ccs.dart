...
void main() {
  runApp(const parqccs2());
}

class parqccs2 extends StatelessWidget {
  const parqccs2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un parque dedicado a la Virgen del Carmen, con un monumento en su honor, áreas verdes, juegos infantiles y un kiosko para eventos. Ideal para pasar un día en familia o hacer un picnic.',
      'Abierto las 24 horas del día, los 7 días de la semana.',
      'Entrada gratuita.',
      0,
      'Barrio El Carmen, Bluefields, Bluefields, Costa Caribe Sur, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque El Carmen', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/pccs2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
