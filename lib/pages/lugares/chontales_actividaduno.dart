...
void main() {
  runApp(const chontales_actividaduno());
}

class chontales_actividaduno extends StatelessWidget {
  const chontales_actividaduno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Cascadas de Chontales',
      'Una caminata corta te lleva a las Cascadas de Chontales, donde podrás refrescarte en sus aguas cristalinas y disfrutar de la belleza natural del lugar. Relájate bajo la cascada, toma fotos y respira aire puro.',
      'Abre todos los días.',
      'Entrada gratuita.',
      84743048,
      'Ubicado a 3 km del centro de Chontales, Nicaragua.',
      'Fácil.',
      'Aproximadamente 1 hora de ida y vuelta.',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cascadas de Chontales', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/mbCzC9VGH3UAcErB8';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chontales3.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
