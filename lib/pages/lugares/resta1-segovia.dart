...
void main() {
  runApp(const resnuevasego1());
}

class resnuevasego1 extends StatelessWidget {
  const resnuevasego1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un restaurante familiar que sirve platos típicos nicaragüenses en un ambiente acogedor y hogareño. Disfruta de una deliciosa chancha en pinol, un plato de gallo pinto o un rico vigorón.',
      'Abierto de lunes a domingo de 7:00 a 22:00 horas.',
      'RRango de precios bajo.',
      73723456,
      'Contiguo al parque central de Ocotal, Ocotal, Nueva Segovia, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Restaurante El Fogón', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/iDVj7xpb4fqjngc7A  ';
 @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/r1sego.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
