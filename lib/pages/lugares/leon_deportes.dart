...
void main() {
  runApp(const leon_deportes());
}

class leon_deportes extends StatelessWidget {
  const leon_deportes({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Club Deportivo León',
      'El Club Deportivo León es un complejo deportivo que ofrece instalaciones para una variedad de deportes. Es ideal para quienes buscan participar en deportes de equipo o actividades al aire libre.',
      'Lunes a Domingo: 6:00 AM - 10:00 PM',
      'Membresía mensual: 30 dólares. Acceso diario: 5 dólares. Clases de natación: 15 dólares por mes.',
      23125678,
      'Frente a la Universidad Nacional Autónoma de Nicaragua (UNAN), León, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Club Deportivo León', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/RUukR5vqbBTWG5wV6';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/leon9.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
