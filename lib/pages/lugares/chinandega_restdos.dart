...
void main() {
  runApp(const chinandega_restdos());
}

class chinandega_restdos extends StatelessWidget {
  const chinandega_restdos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Pizza Hut',
      'Pizza Hut es una cadena internacional de restaurantes de comida rápida especializada en la elaboración de pizzas.',
      'Lunes a Jueves: 11:00am-09:30pm. Viernes y Sábado: 11:00am-10:00pm. Domingo: 11:00am-09:30pm',
      '',
      22559393,
      'Ubicado de donde fue el BANIC 2 cuadras al sur, Chinandega, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Pizza Hut', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'hhttps://maps.app.goo.gl/2jpdPL6gNeLxzcSi8';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chi2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
