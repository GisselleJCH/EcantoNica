...
void main() {
  runApp(const masaya_deportedos());
}

class masaya_deportedos extends StatelessWidget {
  const masaya_deportedos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Sport Arena',
      'Centro recreativo y deportivo. Canchas de fútbol y volleyball',
      'Siempre Abierto',
      'Precios varian según actividad.',
      25281522,
      'Carretera vieja de Nindiri a Masaya, Nindirí, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Sport Arena', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/42qFMnAouuezbrCE6';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/masaya8.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
