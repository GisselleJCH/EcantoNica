...
class senccs extends StatelessWidget {
  const senccs({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un sendero moderado que te lleva a la cima del Cerro Wawawás, donde puedes disfrutar de vistas panorámicas impresionantes de la región.',
      'Abierto todos los días. Se recomienda iniciar la caminata temprano por la mañana.',
      'Entrada gratuita.',
      71726789,
      'A 50 km de Bluefields, Bluefields, Costa Caribe Sur, Nicaragua.',
      'Moderado.',
      'Aproximadamente 4 horas de ida y vuelta.',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Sendero Cerro Wawawás', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/Cm2bAZbVzabNhutz7 ';
 @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/sccs1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
