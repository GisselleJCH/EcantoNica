...
class hman1 extends StatelessWidget {
  const hman1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un palacio histórico que alberga el Museo Nacional de Nicaragua, con una colección de piezas arqueológicas, objetos históricos y culturales del país. Aprende sobre la historia, tradiciones y costumbres de Nicaragua.',
      'Abierto de martes a domingo de 8:00 a 12:00 y de 13:00 a 17:00 horas. Cerrado los lunes.',
      'Entrada: US 2.',
      0,
      'Centro de la ciudad de Managua, Managua, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Palacio Nacional de la Cultura', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/sfL4BLL7GnLi1V4C7 ';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/hman1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
