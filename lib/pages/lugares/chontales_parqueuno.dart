...
void main() {
  runApp(const chontales_parqueuno());
}

class chontales_parqueuno extends StatelessWidget {
  const chontales_parqueuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Parque Central de Chontales',
      'Un parque central rodeado de árboles frondosos, bancas para sentarse y una fuente. Un lugar ideal para relajarse, observar a la gente y disfrutar del ambiente local.',
      'Abre las 24 horas del día, los 7 días de la semana.',
      '',
      0,
      'Ubicado en centro Chontales, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Central de Chontales', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/KfbKiuWaJHkhpK597';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chontales5.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
