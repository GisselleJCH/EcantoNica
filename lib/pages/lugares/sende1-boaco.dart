...
void main() {
  runApp(const sboaco1());
}

class sboaco1 extends StatelessWidget {
  const sboaco1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'El Cerro Apó alberga el pico más alto de Nicaragua y ofrece una caminata desafiante pero gratificante hasta la cima. Disfruta de vistas panorámicas impresionantes del paisaje circundante, observa la flora y fauna local y respira aire puro.',
      'Abierto todos los días. Se recomienda iniciar la caminata temprano por la mañana.',
      'Entrada gratuita.',
      71726789,
      'A 30 km de Boaco, Boaco, Nicaragua.',
      'Alto',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cerro Apó', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/4AoFwPX2LRJxSGUD7 ';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
