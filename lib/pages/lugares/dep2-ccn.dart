...
class dccn2 extends StatelessWidget {
  const dccn2({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      0,
      'Barrio Santa Rosa, Bilwi, Puerto Cabezas, Costa Caribe Norte, Nicaragua.',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Complejo Deportivo Marvin Dixon', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/dccn3.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
