...
void main() {
  runApp(const granada_actividaddos());
}

class granada_actividaddos extends StatelessWidget {
  const granada_actividaddos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Paseo en Carruaje en Granada',
      'Durante el paseo, pasará por antiguas casas coloniales y otros edificios importantes como el Convento San Francisco o la Iglesia de Guadalupe. Granada tiene calles angostas que usualmente son de una vía. Los carruajes disputaráncon carros y ciclistas por el poco espacio, lo que puede ser una aventura.',
      'Abre de lunes a domingo, 06:00am-06:00pm',
      'Media hora por 5 dólares, una hora por 10 dólares',
      85524008,
      'Podrá encontrar fácilmente los carruajes alineados en el Parque Central.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Paseo en Carruaje en Granada - Tyron', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/XHJYZEqSHVKgUdii8';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/granada4.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
