...
void main() {
  runApp(const leon_actividaddos());
}

class leon_actividaddos extends StatelessWidget {
  const leon_actividaddos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Jardín Botánico León',
      'Un espacio verde con una gran variedad de plantas y flores, ideal para relajarse y disfrutar de la naturaleza.',
      'Abre de lunes a domingo, 08am-05pm',
      'Precio de entrada: Adultos: 50 córdobas, Niños: 25 córdobas.',
      0,
      'Ubicado en Km 5 Ctra a León-Managua, León, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Jardín Botánico León', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/QEqC4xaECHNNC72V9';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/leon4.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
