...
void main() {
  runApp(const rivas_parques());
}

class rivas_parques extends StatelessWidget {
  const rivas_parques({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Central de Rivas', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/RxqY4BjnaCg6zzp76';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/rivas5.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
