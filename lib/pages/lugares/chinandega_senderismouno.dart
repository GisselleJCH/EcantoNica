...
void main() {
  runApp(const chinandega_senderismouno());
}

class chinandega_senderismouno extends StatelessWidget {
  const chinandega_senderismouno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Cerro El Chonco',
      'Una caminata moderada hasta la cima del Cerro El Chonco te recompensa con vistas panorámicas de la ciudad de Chinandega y el volcán San Cristóbal.',
      'Abierto de Lunes a Domingo.',
      'Entrada gratuita.',
      0,
      'A 10 km del centro de Chinandega, Nicaragua.',
      'Moderado.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cerro El Chonco', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/phiP85SfQ1jsmUx3A';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chi7.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
