...
class rji1 extends StatelessWidget {
  const rji1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un restaurante familiar que sirve platos típicos nicaragüenses y una amplia variedad de cafés en un ambiente acogedor y hogareño. Disfruta de un delicioso nacatamal, un plato de gallo pinto o un rico vigorón acompañado de un café Jinotega recién tostado.',
      'Abierto de lunes a domingo de 7:00 a 22:00 horas.',
      'Rango de precios bajo.',
      88723456,
      'Contiguo al parque central de Jinotega, Jinotega, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Restaurante Café Jinotega', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/resjino1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
