...
void main() {
  runApp(const rivas_restdos());
}

class rivas_restdos extends StatelessWidget {
  const rivas_restdos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'La Parrilla Drinks & Food',
      ...
      'Abierto de lunes a domingo de 8a.m. - 12 a.m.',
      'Rango de precios alto.',
      85371836,
      'F553+VWH, Los Ranchos, Rivas',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'La Parrilla Drinks & Food', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/ndF3JS5CBGbxpy3BA';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/rivas2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
