...
void main() {
  runApp(const actrio1());
}

class actrio1 extends StatelessWidget {
  const actrio1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'El Refugio de Vida Silvestre Castillo alberga una gran variedad de flora y fauna, incluyendo bosques húmedos, lagunas y ríos. Disfruta de senderismo, observación de aves, paseos en bote y otras actividades al aire libre.',
      'Abierto todos los días. Se recomienda llegar temprano en la mañana o al final de la tarde para evitar el calor del sol.',
      'Entrada: US 5.',
      71726789,
      'A 15 km de El Castillo, El Castillo, Río San Juan, Nicaragua.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Refugio de Vida Silvestre Castillo', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/actrio1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
