...
void main() {
  runApp(const sendeccn1());
}

class sendeccn1 extends StatelessWidget {
  const sendeccn1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'El Cerro Mayangkuang es la montaña más alta de la Costa Caribe Norte y ofrece una caminata desafiante pero gratificante hasta la cima. Disfruta de vistas panorámicas impresionantes del paisaje circundante, observa la flora y fauna local y siente la adrenalina de estar en la cima de una montaña.',
      'Abierto todos los días. Se recomienda iniciar la caminata temprano por la mañana.',
      'Entrada gratuita.',
      71726789,
      'A 60 km de Bilwi, Puerto Cabezas, Costa Caribe Norte, Nicaragua.',
      'Altamente desafiante.',
      'Aproximadamente 8 horas de ida y vuelta',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cascada de La Gloria: Un tesoro escondido en Costa Caribe Norte', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/yLFbrkhoYhb9wh8b6';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/sccn1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            ...
            const SizedBox(height: 10),
            _buildSection('Nivel de dificultad', widget.negocio.dificultad!),
             const SizedBox(height: 10),
             _buildSection('Duracion', widget.negocio.duracion!),
              const SizedBox(height: 20),
