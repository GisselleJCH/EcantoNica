...
void main() {
  runApp(const dep1jino());
}

class dep1jino extends StatelessWidget {
  const dep1jino({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      'Varía según el evento deportivo',
      0,
      'Barrio El Recreo, Jinotega, Nicaragua.',
      'Fácil.',
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/JekQJJiHkdnt1ckj9 ';
  @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/depo1jino.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
