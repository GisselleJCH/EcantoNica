...
void main() {
  runApp(const rivas_restuno());
}

class rivas_restuno extends StatelessWidget {
  const rivas_restuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'La Nani Café',
      'Un lugar familiar que tiene un menú de cafés, postres en un ambiente acogedor y hogareño.',
      'Abierto de lunes a domingo de 08:00am a 08:00pm',
      'Rango de precios bajo.',
      25633712,
      'C5QC+RJW, Av. Central Nte., Rivas',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'La Nani Café', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/oM2gtJ8g3yimFFQv9';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/rivas1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
