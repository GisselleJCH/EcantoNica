...
class hmadri extends StatelessWidget {
  const hmadri({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un museo que alberga una colección de piezas arqueológicas, objetos históricos y culturales de la región. Aprende sobre la historia, tradiciones y costumbres de Madriz.',
      'Abierto de martes a domingo de 8:00 a 12:00 y de 13:00 a 17:00 horas. Cerrado los lunes.',
      'Entrada: US 1.',
      0,
      'Barrio Monseñor Lezcano, Somoto, Madriz, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Museo Regional de Somoto', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/hLq9ukVy3xNyeXvq6 ';
 @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/hmadri1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
