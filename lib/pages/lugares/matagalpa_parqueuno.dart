...
void main() {
  runApp(const matagalpa_parqueuno());
}

class matagalpa_parqueuno extends StatelessWidget {
  const matagalpa_parqueuno({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque San Ramón', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/CM6Eutfkn8eMBajc8';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/ma4.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
