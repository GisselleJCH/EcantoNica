...
void main() {
  runApp(const acmadri1());
}

class acmadri1 extends StatelessWidget {
  const acmadri1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'La Reserva Natural Volcán Telica alberga un volcán activo que se puede escalar hasta la cima. Disfruta de vistas panorámicas impresionantes del paisaje circundante, observa la flora y fauna local y siente la adrenalina de estar en un volcán activo.',
      'Abierto todos los días. Se recomienda iniciar la caminata temprano por la mañana.',
      'Entrada: US 5.',
      0,
      'A 20 km de Somoto, Somoto, Madriz, Nicaragua.',
      'Moderado.',
      'Aproximadamente 5 horas de ida y vuelta.',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Reserva Natural Volcán Telica', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/DGh4dQKiVriELa7c9 ';
  @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/actimadri1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
