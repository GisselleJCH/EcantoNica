...
void main() {
  runApp(const masaya_deporteuno());
}

class masaya_deporteuno extends StatelessWidget {
  const masaya_deporteuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Centro Deportivo Excelsior',
      'Centro deportivo, se caracterizan en el alquiler de cancha con grama artificial para fútbol.',
      'Siempre Abierto',
      'Precios varian según actividad.',
      75298847,
      'Centro Deportivo Exclesior masaya, Masaya, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Centro Deportivo Excelsior', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/AKGLKFQAMtWCWj8h9';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/masaya7.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
