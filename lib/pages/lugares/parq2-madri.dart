...
void main() {
  runApp(const parmadr2());
}

class parmadr2 extends StatelessWidget {
  const parmadr2({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      'Entrada gratuita.',
      0,
      'Barrio San José, Somoto, Madriz, Nicaragua.',
      '',
      '',
      ''
    );
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/parmadri2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
