...
void main() {
  runApp(const diriamba_restuno());
}

class diriamba_restuno extends StatelessWidget {
  const diriamba_restuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'La Litrógeno',
      'Un restaurante con un ambiente acogedor y una amplia variedad de platos deliciosos.',
      'Abre de lunes a domingo de 1:00pm a 12:00am.',
      '',
      58368677,
      'VQ45+59M, 4ta. Av NO, C. Central Este, Diriamba 46300, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'La Litrógeno', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://www.google.com/maps/place/La+Litr%C3%B3geno/@11.8555138,-86.2416564,15z/data=!4m2!3m1!1s0x0:0x2df1cce3aebaa94f?sa=X&ved=1t:2428&ictx=111';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/diriamba1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
