...
void main() {
  runApp(const granada_historiados());
}

class granada_historiados extends StatelessWidget {
  const granada_historiados({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Convento e Iglesia de San Francisco',
      'Ruinas del antiguo convento franciscano del siglo XVI, que ofrece una ventana al pasado colonial de la ciudad. Se pueden apreciar arcos, bóvedas y muros de piedra que aún conservan su majestuosidad.',
      'Abierto de lunes a domingo de 8:00am a 06:00pm.',
      'Entrada gratuita.',
      0,
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Convento e Iglesia de San Francisco', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/rQiQmvXjDUoB1Ga76';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/granada11.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
