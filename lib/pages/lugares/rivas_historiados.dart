...
void main() {
  runApp(const rivas_historiados());
}

class rivas_historiados extends StatelessWidget {
  const rivas_historiados({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Museo Regional de Rivas',
      'Un museo que alberga una colección de piezas arqueológicas, objetos históricos y culturales de la región. Aprende sobre la historia, tradiciones y costumbres de Rivas.',
      'Abierto de martes a domingo de 8:00am a 12:00mm y de 1:00pm a 06:00pm. Cerrado los lunes.',
      '1 dólar',
      0,
      'Barrio San Juan, Rivas, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Museo Regional de Rivas', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/MiK5ou4v96KyyFUo7';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/rivas9.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
