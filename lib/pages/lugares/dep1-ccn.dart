...
class dccn1 extends StatelessWidget {
  const dccn1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Estadio Municipal de Bilwi', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/i4MXMaU7f3ECBqNV9 ';
  @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/dccn1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
