...
void main() {
  runApp(const chontales_historia());
}

class chontales_historia extends StatelessWidget {
  const chontales_historia({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Museo Comunitario Juigalpa',
      'Un museo comunitario que alberga una colección de objetos históricos y culturales de la región. Aprende sobre la historia, tradiciones y costumbres de Chontales.',
      'Abierto de lunes a viernes de 8:00am a 12:00mm y de 01:00pm a 05:00pm. Cerrado los fines de semana.',
      '1 dólar.',
      0,
      'Centro de Chontales, Chontales, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Museo Comunitario Juigalpa', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/v9LcUSnVV3z8E2x48';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chontales10.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
