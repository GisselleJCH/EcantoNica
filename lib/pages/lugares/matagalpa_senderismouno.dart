...
void main() {
  runApp(const matagalpa_senderismouno());
}

class matagalpa_senderismouno extends StatelessWidget {
  const matagalpa_senderismouno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Cerro Mogoton',
      'El Cerro Mogoton es la segunda montaña más alta de Nicaragua y ofrece una caminata desafiante pero gratificante hasta la cima. Disfruta de vistas panorámicas impresionantes del paisaje circundante, observa la flora y fauna local y respira aire puro.',
      'Abierto de Lunes a Domingo.',
      'Entrada gratuita',
      0,
      'Se encuentra a 15 km de Matagalpa, Matagalpa, Nicaragua',
      'Alto.',
      '',
      ''
    );
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/Gt6FoidDrMA8mWLW7';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/ma6.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
