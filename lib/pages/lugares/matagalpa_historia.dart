...
void main() {
  runApp(const matagalpa_historia());
}

class matagalpa_historia extends StatelessWidget {
  const matagalpa_historia({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Catedral de Matagalpa',
      'Una imponente catedral construida en el siglo XIX, que destaca por su arquitectura neoclásica y su fachada ornamentada. Admira su interior majestuoso y conoce su historia religiosa.',
      'Abierto de lunes a domingo de 8:00am a 12:00mm y de 01:00pm a 06:00pm.',
      'Gratis.',
      0,
      'Centro de la ciudad de Matagalpa, Matagalpa, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Catedral de Matagalpa', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/eKQnda1S9Gpm7XAb7';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/ma8.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
