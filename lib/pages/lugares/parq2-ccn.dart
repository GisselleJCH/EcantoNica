...
class pccn2 extends StatelessWidget {
  const pccn2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un parque dedicado a la historia del banano en la región, con un monumento en su honor, áreas verdes, juegos infantiles y un kiosko para eventos. Ideal para pasar un día en familia o hacer un picnic.',
      'Abierto las 24 horas del día, los 7 días de la semana.',
      'Entrada gratuita.',
      0,
      'Barrio Bananero, Bilwi, Puerto Cabezas, Costa Caribe Norte, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Bananero', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/pccn2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
