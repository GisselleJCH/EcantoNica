...
class hiscs extends StatelessWidget {
  const hiscs({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un museo que alberga una colección de piezas arqueológicas, objetos históricos y culturales de la región. Aprende sobre la historia, tradiciones y costumbres de la Costa Caribe Sur.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Museo Regional de Bluefields', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/QVPbmmVCVTqAaywFA ';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/hccs1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
