...
void main() {
  runApp(const granada_parquedos());
}

class granada_parquedos extends StatelessWidget {
  const granada_parquedos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Parque Xalteva',
      'Un parque grande con áreas verdes, senderos para caminar y un área de juegos para niños. Un lugar ideal para hacer ejercicio o pasar un día en familia.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Xalteva', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/T5TnxDbuyPcxUN8e9';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/granada6.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
