...
void main() {
  runApp(const masaya_parqueuno());
}

class masaya_parqueuno extends StatelessWidget {
  const masaya_parqueuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Parque Natural Masaya',
      'Un parque natural con senderos para caminar, miradores para observar los volcanes y la oportunidad de ver la lava incandescente',
      'Lunes a Domingo, 10 am-9pm',
      '',
      0,
      'La Villa 10 de Mayo, semáforos de la INCA 1 cuadra al norte, 1/2 cuadra al este. Masaya, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Natural Masaya', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.google.com/?cid=18333397627720896036';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/masaya3.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
