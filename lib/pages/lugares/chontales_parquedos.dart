...
void main() {
  runApp(const chontales_parquedos());
}

class chontales_parquedos extends StatelessWidget {
  const chontales_parquedos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Parque Ecológico Chontales',
      'Un parque ecológico con senderos para caminar, áreas verdes, una zona de juegos infantiles y un kiosko para eventos. Ideal para pasar un día en familia o hacer un picnic.',
      'Abre los 7 días de la semana.',
      '',
      0,
      'Ubicado a 1km centro Chontales, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Ecológico Chontales', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/nwrogzM6BAc4rxxe6';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chontales6.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
