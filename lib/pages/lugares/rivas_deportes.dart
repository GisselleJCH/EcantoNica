...
void main() {
  runApp(const rivas_deportes());
}

class rivas_deportes extends StatelessWidget {
  const rivas_deportes({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Estadio Yamil Rios Ugarte',
      ...
      '',
      25633058,
      'Barrio San Pedro, Rivas, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Estadio Yamil Rios Ugarte', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/DVi68nkvFahrfNpM8';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/rivas7.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
