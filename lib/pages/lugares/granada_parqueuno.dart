...
void main() {
  runApp(const granada_parqueuno());
}

class granada_parqueuno extends StatelessWidget {
  const granada_parqueuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Parque Central de Granada',
      'Un parque central hermoso y animado con árboles frondosos, bancos para sentarse y una fuente. Un lugar perfecto para relajarse y observar a la gente.',
      'Abre de lunes a domingo',
      '',
      0,
      'Ubicado en granada, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Central de Granada', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/wvEmfzydVRMHwE7J7';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/granada5.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
