...
class sego1 extends StatelessWidget {
  const sego1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Reserva Natural Tizate',
      'La Reserva Natural Tizate alberga una gran variedad de flora y fauna, incluyendo bosques nubosos, cascadas y miradores con vistas panorámicas. Disfruta de senderismo, observación de aves, ciclismo y otras actividades al aire libre.',
      'Abierto todos los días',
      'Entrada: US 5.',
      71726789,
      'A 20 km de Ocotal, Ocotal, Nueva Segovia, Nicaragua.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Reserva Natural Tizate', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/RZ5RK826hnx9GZBj8';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/sego1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            ...
            const SizedBox(height: 10),
            _buildSection('Duración', widget.negocio.duracion!),
            const SizedBox(height: 20),
