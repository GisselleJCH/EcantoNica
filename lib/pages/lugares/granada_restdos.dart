...
void main() {
  runApp(const granada_restdos());
}

class granada_restdos extends StatelessWidget {
  const granada_restdos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Bistro Estrada',
      'Un restaurante elegante que ofrece cocina internacional y nicaragüense en un ambiente moderno.',
      'Abre de lunes a domingo de 12:00mm a 10:00pm, excepto los miércoles que está cerrado. ',
      '',
       25527394,
      'Ubicado en Calle Arsenal. Granada, Nicaragua., Calle El Arsenal, Granada, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Bistro Estrada', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/bScJcUbayKfDBi859';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/granada2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
  ...
  Widget _buildSection(String title, String content, [VoidCallback? onTap]) {
    final textColor = onTap != null ? Colors.blue : Colors.black;
    final textDecoration = onTap != null ? TextDecoration.underline : TextDecoration.none;
