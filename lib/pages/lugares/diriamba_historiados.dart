...
void main() {
  runApp(const diriamba_historiados());
}

class diriamba_historiados extends StatelessWidget {
  const diriamba_historiados({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Reloj Público de Diriamba',
      'Un símbolo de la ciudad, este reloj fue construido en 1935 y se encuentra ubicado en el Parque Central. Es un punto de encuentro popular y un recordatorio de la tradición relojera de Diriamba.',
      'Abre de lunes a Domingo, 07:00a,-09:00pm.',
      '',
      0,
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Reloj Público de Diriamba', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/VhpLMfXokVe7QBTq8';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/diriamba10.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
