...
void main() {
  runApp(const diriamba_historiauno());
}

class diriamba_historiauno extends StatelessWidget {
  const diriamba_historiauno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Basílica Menor de San Sebastián',
      'Esta imponente iglesia de estilo neoclásico fue construida en el siglo XIX y es considerada uno de los monumentos más importantes de Diriamba. Destaca por su arquitectura, sus obras de arte religioso y su valor histórico.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Basílica Menor de San Sebastián', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/6WgmzXNup8yT3FiF7';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/diriamba9.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
