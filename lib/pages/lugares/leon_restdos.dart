...
void main() {
  runApp(const leon_restdos());
}

class leon_restdos extends StatelessWidget {
  const leon_restdos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'El Bodegón',
      'Un restaurante que ofrece comida en hora feliz · Ofrece buenos cócteles · Ofrece platos vegetarianos',
      'Abre de lunes a domigno, 12:00am-11:00pm',
      '',
      89753014,
      'Parque Rubén Darío, 2da av. NO del, 50 metros al norte, León, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'El Bodegón', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/z4y5iFXR6F79QSTv5';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/leon2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
