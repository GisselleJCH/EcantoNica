...
void main() {
  runApp(const chinandega_deportedos());
}

class chinandega_deportedos extends StatelessWidget {
  const chinandega_deportedos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Estadio de Fútbol Enel',
      'Un estadio de fútbol con capacidad para 8.000 espectadores, sede del equipo local Chinandega FC. Disfruta de la emoción de un partido de fútbol en un ambiente vibrante.',
      'Varía según los eventos deportivos.',
      '',
      0,
      'Ubicado a 2 km del centro de Chinandega, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Estadio de Fútbol Enel', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/M8BTcVp6j29QJVEn6';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chi10.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
