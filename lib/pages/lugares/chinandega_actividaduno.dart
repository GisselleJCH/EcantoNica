...
void main() {
  runApp(const chinandega_actividaduno());
}

class chinandega_actividaduno extends StatelessWidget {
  const chinandega_actividaduno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Volcán San Cristóbal',
      'El volcán San Cristóbal es el más alto de Nicaragua y ofrece una caminata desafiante pero gratificante hasta la cima. Disfruta de impresionantes vistas panorámicas del paisaje circundante.',
      'Abre todos los días.',
      'Entrada gratuita.',
      84743048,
      'Ubicado a 16 km de Chinandega, Chinandega, Nicaragua.',
      'Alta',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Volcán San Cristóbal', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/b1jJLbbuDddGnKSn6';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chi3.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
  ...
  void addToFavorites(Negocio negocio) {
    FavoritosManager.addFavorito(negocio);
  }
}

class FavoritosManager {
  static final List<Negocio> _favoritos = [];

  static void addFavorito(Negocio negocio) {
    _favoritos.add(negocio);
  }

  static List<Negocio> getFavoritos() {
    return _favoritos;
  }
}