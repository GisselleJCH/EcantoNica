...
void main() {
  runApp(const actmana());
}

class actmana extends StatelessWidget {
  const actmana({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'El Puerto Salvador Allende está lleno de restaurantes, bares y parques infantiles, por lo que es un sitio muy importante ubicado junto al lago en Managua. Este centro de actividad moderno ofrece una vista espectacular del agua. Ven a cenar al atardecer para disfrutar tu comida contemplando el hermoso paisaje mientras oscurece.',
      '',
      'Precios entre 10 a 80 córdobas (entrada)',
      55016289,
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Puerto Salvador Allende', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/7DpCYBTQnh9PvzheA ';
   @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/actiman1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            const SizedBox(height: 20),
            _buildSection('Descripcion', widget.negocio.descripcion!),
