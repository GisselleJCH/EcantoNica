...
void main() {
  runApp(const masaya_actividad());
}

class masaya_actividad extends StatelessWidget {
  const masaya_actividad({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Malecón Masaya',
      'Un lugar para caminar, miradores para observar los volcanes y la oportunidad de ver la lava incandescente.',
      'Lunes a Domingo. 08am-08pm',
      '',
      0,
      'Masaya, Nicaragua.',
      '',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Malecón Masaya', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://www.google.com/maps/place/Malec%C3%B3n+Masaya/@11.9741147,-86.1049658,15z/data=!4m2!3m1!1s0x0:0x6ee10dcf396cce8f?sa=X&ved=1t:2428&ictx=111';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/masaya11.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
