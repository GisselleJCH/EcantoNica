...
void main() {
  runApp(const chinandega_parqueuno());
}

class chinandega_parqueuno extends StatelessWidget {
  const chinandega_parqueuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Parque Central de Chinandega',
      'Un parque central vibrante rodeado de árboles frondosos, bancas para sentarse y una fuente. Un lugar perfecto para relajarse, observar a la gente y disfrutar del ambiente local.',
      'Abre las 24 horas del día, los 7 días de la semana.',
      '',
      0,
      'Ubicado en el Centro de la ciudad de Chinandega, Chinandega, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Central de Chinandega', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/rXyBi3Mfq6PKrdmcA';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chi5.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
