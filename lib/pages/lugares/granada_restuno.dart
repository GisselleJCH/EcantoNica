...
void main() {
  runApp(const granada_restuno());
}

class granada_restuno extends StatelessWidget {
  const granada_restuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Restaurante El Zaguán',
      'Un restaurante tradicional nicaragüense con un ambiente acogedor y una amplia variedad de platos.',
      'Abre de lunes a domingo de 12:00mm a 9:00pm, excepto los viernes que abre de 12:30pm a 09:00pm.',
      '',
      25522522,
      'Ubicado en Costado Este Iglesia, Catedral, Granada 43000, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Restaurante El Zaguán', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/dVJxNZ8EPAHbVENZ7';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/granada1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
