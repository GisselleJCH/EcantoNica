...
void main() {
  runApp(const matagalpa_restdos());
}

class matagalpa_restdos extends StatelessWidget {
  const matagalpa_restdos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Buffet Oasis',
      'Un restaurante que ofrece un bufet cada día para el disfrute de la variedad de comidas.',
      'Abre de lunes a sábado, 07:00am-05:00pm.',
      '',
      27723833,
      'Centro de Matagalpa, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Buffet Oasis', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/WJyVDB9CYMvrkiCH6';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/ma2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
