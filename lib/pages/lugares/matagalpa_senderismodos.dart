...
void main() {
  runApp(const matagalpa_senderismodos());
}

class matagalpa_senderismodos extends StatelessWidget {
  const matagalpa_senderismodos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Cascadas de La Luna',
      'Un sendero te lleva a las Cascadas de La Luna, donde podrás refrescarte en sus aguas cristalinas y disfrutar de la belleza natural del lugar. Relájate bajo la cascada, toma fotos y respira aire puro.',
      'Abierto de Lunes a Domingo, 8am - 5pm',
      'Entrada gratuita',
      0,
      'Ubicado en Matagalpa, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cascadas de La Luna', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/rQMotFmUWsCgE82j8';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/ma9.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
