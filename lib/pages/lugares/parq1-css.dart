...
void main() {
  runApp(const parqccs1());
}

class parqccs1 extends StatelessWidget {
  const parqccs1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      'Entrada gratuita.',
      0,
      'Centro de la ciudad de Bluefields, Bluefields, Costa Caribe Sur, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Central de Bluefields', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/1ro6e8UfRSz99dNN9 ';
 @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/pccs1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
