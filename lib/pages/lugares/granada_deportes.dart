...
void main() {
  runApp(const granada_deportes());
}

class granada_deportes extends StatelessWidget {
  const granada_deportes({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Cancha de Fútbol',
      'Se caracterizan en el alquiler de cancha para fútbol.',
      'Siempre Abierto',
      'Precios varian según actividad.',
      0,
      'Cancha de Fútbol Granada, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cancha de Fútbol', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/Sbaj9paRtgXQ2yzQ7';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/granada9.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
