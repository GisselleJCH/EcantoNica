...
void main() {
  runApp(const leon_restuno());
}

class leon_restuno extends StatelessWidget {
  const leon_restuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'El Sesteo',
      'Un restaurante con asientos al aire libre, también ofrece buenos cócteles y ofrece platos vegetarianos',
      'Abre de lunes a sábado, 11:00am-10:30pm. Domigno, 10:00am-09:30pm',
      '',
      23115327,
      'NIC-14, León, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'El Sesteo', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/zi8Lc1favMF9kRum9';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/leon1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
