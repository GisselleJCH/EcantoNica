...
void main() {
  runApp(const diriamba_parquedos());
}

class diriamba_parquedos extends StatelessWidget {
  const diriamba_parquedos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Parque de ferias Diriamba',
      'Un parque con áreas verdes, juegos infantiles y un ambiente familiar.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque de ferias Diriamba', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.google.com/?cid=12254179458642412984';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/diriamba6.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
