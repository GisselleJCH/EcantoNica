...
void main() {
  runApp(const chinandega_senderismodos());
}

class chinandega_senderismodos extends StatelessWidget {
  const chinandega_senderismodos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Cascadas de Santa Rosa',
      'Un sendero pintoresco te lleva a las Cascadas de Santa Rosa, donde podrás refrescarte en sus aguas cristalinas y disfrutar del paisaje natural.',
      'Abierto de Lunes a Domingo.',
      'Entrada gratuita.',
      0,
      'A 18 km del centro de Chinandega, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cascadas de Santa Rosa', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/K7NjpEKp8K3bDTkW6';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chi8.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
