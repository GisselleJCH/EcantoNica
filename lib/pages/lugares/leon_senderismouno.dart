...
void main() {
  runApp(const leon_senderismouno());
}

class leon_senderismouno extends StatelessWidget {
  const leon_senderismouno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Cerro Negro',
      'Un volcán activo que ofrece una experiencia única de senderismo con vistas impresionantes del paisaje circundante. Se recomienda contratar un guía turístico para realizar esta actividad.',
      'Abierto de Lunes a Domingo.',
      'El precio varía según el tour que elijas.',
      0,
      'Se encuentra ubicado en León, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cerro Negro', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/2VZGZE2zxfM2DqwV9';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/leon6.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
