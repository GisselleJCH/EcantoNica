...
void main() {
  runApp(const masaya_restdos());
}

class masaya_restdos extends StatelessWidget {
  const masaya_restdos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'El Crustaceo',
      'Un restaurante de mariscos con un menú fresco y precios razonables.',
      'Lunes a Domingo de 11am-10pm',
      '',
      83963683,
      '1 Calle Sur-Oeste, Masaya, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'El Crustaceo', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.google.com/?cid=9462267337498723156';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/masaya2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
