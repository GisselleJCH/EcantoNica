...
void main() {
  runApp(const chontales_restuno());
}

class chontales_restuno extends StatelessWidget {
  const chontales_restuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Restaurante La Esquina',
      'Un restaurante familiar que sirve platos típicos nicaragüenses en un ambiente acogedor y hogareño. Disfruta de deliciosas tortillas caseras, fresco queso y frijoles, carne asada y otros platillos tradicionales.',
      'Abre de lunes a domingo de 07:00am - 8:00pm',
      'Rango de precios bajos.',
      87892345,
      'Ubicado Contiguo a la iglesia católica, Chontales, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Restaurante La Esquina', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/WH9kDSKWuaPbost88';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chontales1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
