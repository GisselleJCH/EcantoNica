...
void main() {
  runApp(const sendemadri1());
}

class sendemadri1 extends StatelessWidget {
  const sendemadri1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'El Cerro Mogoton alberga el pico más alto de Nicaragua y ofrece una caminata desafiante pero gratificante hasta la cima. Disfruta de vistas panorámicas impresionantes del paisaje circundante, observa la flora y fauna local y respira aire puro.',
      'Abierto todos los días. Se recomienda iniciar la caminata temprano por la mañana.',
      'Entrada gratuita.',
      71726789,
      'A 25 km de Ocotal, Ocotal, Nueva Segovia, Nicaragua.',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cerro Mogoton', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/f1FwaHjkechTmRgU6';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/senmadri1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
