...
void main() {
  runApp(const rivas_actividadesuno());
}

class rivas_actividadesuno extends StatelessWidget {
  const rivas_actividadesuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'volcán concepción',
      'El volcán Concepción es uno de los dos volcanes de la isla de Ometepe, en el Lago Cocibolca, en el departamento de Rivas, Nicaragua.',
      'Abierto todos los días. Se recomienda iniciar la caminata temprano por la mañana.',
      '',
      0,
      'A 15 km de Rivas, Rivas, Nicaragua.',
      'Alto.',
      'Aproximadamente 7 horas de ida y vuelta.',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Volcán concepción', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/uj7wVkHqUUNQKzac7';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/rivas3.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
