...
void main() {
  runApp(const diriamba_actividaduno());
}

class diriamba_actividaduno extends StatelessWidget {
  const diriamba_actividaduno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Finca el Madroñal',
      'Un lugar perfecto para disfrutar de la naturaleza y realizar actividades al aire libre como senderismo, ciclismo y observación de aves. ',
      'Abre de lunes a sábado de 24 horas, y domingo cerrado. ',
      '',
      84743048,
      'Ubicado en Instituto Diriangen 1000 metros al sur, Diriamba, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Finca el Madroñal', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.google.com/?cid=3195800773454962037';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/diriamba3.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
