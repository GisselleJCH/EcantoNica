...
class rsan2 extends StatelessWidget {
  const rsan2({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      50589726789,
      'Barrio El Carmen, San Carlos, Río San Juan, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Restaurante La Casona del Mar', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/rsan2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
