...
void main() {
  runApp(const masaya_historiauno());
}

class masaya_historiauno extends StatelessWidget {
  const masaya_historiauno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Antigua Estación de Ferrocarril',
      'Un edificio histórico que ahora alberga un museo que narra la historia del ferrocarril en Nicaragua. Es una construcción moderna de concreto monolítico. Su construcción data de 1926.',
      'Siempre Abierto',
      'Gratis.',
      0,
      'Se ubica en el sector norte de la ciudad, Masaya, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Antigua Estación de Ferrocarril', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.google.com/?cid=1909657904275233388';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/masaya9.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
