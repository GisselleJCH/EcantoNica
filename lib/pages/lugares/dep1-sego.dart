...
void main() {
  runApp(const desego1());
}

class desego1 extends StatelessWidget {
  const desego1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      'Varía según el evento deportivo',
      0,
      'Barrio El Recreo, Ocotal, Nueva Segovia, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Estadio José Reinerio Guerra', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/depo1sego.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
