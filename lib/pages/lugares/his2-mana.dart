...
class hman2 extends StatelessWidget {
  const hman2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Una imponente catedral construida en el siglo XX, que destaca por su arquitectura neobizantina y sus coloridos vitrales. Admira su interior majestuoso y conoce su historia religiosa.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Catedral Metropolitana de Managua', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/AKysypaZWkj7gHTe7 ';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/hman2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
