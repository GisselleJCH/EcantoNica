...
void main() {
  runApp(const chinandega_historiauno());
}

class chinandega_historiauno extends StatelessWidget {
  const chinandega_historiauno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Catedral de Chinandega',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Catedral de Chinandega', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/a4ZpkEuhoXt4jJA9A';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chi11.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
