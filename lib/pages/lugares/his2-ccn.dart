...
void main() {
  runApp(const his2ccn());
}

class his2ccn extends StatelessWidget {
  const his2ccn({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un fuerte colonial construido en el siglo XVII, que sirvió como defensa contra los piratas y los ataques ingleses. Recorre sus murallas, conoce su historia y disfruta de las vistas panorámicas del mar Caribe.',
      'Abierto todos los días de 8:00 a 17:00 horas.',
      'Entrada: US 3.',
      0,
      'A 10 km de Bilwi, Puerto Cabezas, Costa Caribe Norte, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Fuerte El Bluff', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/PCBFAyPZPG2eDzdK8 ';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/hccn2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
