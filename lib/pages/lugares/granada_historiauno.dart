...
void main() {
  runApp(const granada_historiauno());
}

class granada_historiauno extends StatelessWidget {
  const granada_historiauno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Catedral de Granada',
      'Imponente catedral construida en el siglo XVI, considerada una de las más importantes de Centroamérica. Destaca su fachada barroca, sus dos torres campanario y su interior ornamentado.',
      'Abierto de lunes a viernes de 8:00am a 12:00mm y de 1:00pm a 06:00pm. Sábados y domingos de 8:00am a 12:00mm.',
      'Entrada gratuita.',
      0,
      'Se encuentra ubicado en Parque Central, Granada, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Catedral de Granada', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/yQjYSiLtyyJioxKb6';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/granada10.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
