...
void main() {
  runApp(const leon_actividaduno());
}

class leon_actividaduno extends StatelessWidget {
  const leon_actividaduno({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Central de León', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/9j6X7wX98jfobVN98';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/leon3.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
