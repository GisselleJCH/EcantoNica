...
void main() {
  runApp(const rivas_actividadesdos());
}

class rivas_actividadesdos extends StatelessWidget {
  const rivas_actividadesdos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Reserva Natural Península de Huehuetepe',
      'La Reserva Natural Península de Huehuetepe alberga una gran variedad de flora y fauna, incluyendo bosques secos tropicales, manglares y playas vírgenes. Disfruta de senderismo, observación de aves, pesca y otras actividades al aire libre.',
      'Abierto todos los días.',
      '5 dólares',
      0,
      'A 20 km de Rivas, Rivas, Nicaragua.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Reserva Natural Península de Huehuetepe', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/8S6fcwLxiefShSmLA';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/rivas4.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
