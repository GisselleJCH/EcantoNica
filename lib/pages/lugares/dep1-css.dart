...
class deccs1 extends StatelessWidget {
  const deccs1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      'Varía según el evento deportivo',
      0,
      'Barrio El Recreo, Bluefields, Bluefields, Costa Caribe Sur, Nicaragua.',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Estadio Municipal de Bluefields', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/S1GUHTUM2ALSsWnv5';
   @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/dccs1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
