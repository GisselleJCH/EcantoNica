...
void main() {
  runApp(const chinandega_parquedos());
}

class chinandega_parquedos extends StatelessWidget {
  const chinandega_parquedos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Parque San Antonio',
      'Un parque familiar con áreas verdes, juegos infantiles, una cancha de fútbol y un kiosko para eventos. Ideal para pasar un día en familia o hacer un picnic.',
      'Abre las 24 horas del día, los 7 días de la semana.',
      '',
      0,
      'Ubicado en el Barrio San Antonio, Chinandega, Chinandega, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque San Antonio', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/bxqYgSMZdjtDPd9m6';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chi6.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
