...
void main() {
  runApp(const act1boaco());
}

class act1boaco extends StatelessWidget {
  const act1boaco({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Reserva Natural Cerro Mogoton',
      'La Reserva Natural Cerro Mogoton alberga el pico más alto de Nicaragua, el Cerro Mogoton, y ofrece una variedad de senderos para caminar con diferentes niveles de dificultad. Disfruta de impresionantes vistas panorámicas, observa la flora y fauna local y respira aire puro.',
      'Abierto todos los días. Se recomienda iniciar la caminata temprano por la mañana.',
      'Entrada: US 5.',
      0,
      'A 20 km de Boaco, Boaco, Nicaragua.',
      'Varía según el sendero elegido.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Reserva Natural Cerro Mogoton', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  bool isFavorite = false;
   ...
   final String googleMapsUrl = 'https://maps.app.goo.gl/XoBzciwWFt4zJmPZ6  ';
   @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
