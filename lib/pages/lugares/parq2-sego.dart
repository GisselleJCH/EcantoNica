...
void main() {
  runApp(const parsego2());
}

class parsego2 extends StatelessWidget {
  const parsego2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un parque dedicado al poeta nicaragüense Rubén Darío, con un monumento en su honor, áreas verdes, juegos infantiles y un kiosko para eventos. Ideal para pasar un día en familia o hacer un picnic.',
      'Abierto las 24 horas del día, los 7 días de la semana.',
      'Entrada gratuita.',
      0,
      'Barrio San José, Ocotal, Nueva Segovia, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Rubén Darío', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/gdzzxffuMqHJNvYz6 ';
 @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/par2sego.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
