...
void main() {
  runApp(const leon_senderismodos());
}

class leon_senderismodos extends StatelessWidget {
  const leon_senderismodos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Reserva Natural Península de León',
      'Un área protegida con una rica biodiversidad, ideal para realizar senderismo, observación de flora y fauna y camping.',
      'Abierto de Lunes a Domingo.',
      'El precio varía según el tour que elijas.',
      0,
      'Se encuentra a 25-30 km al este de la ciudad de León y a 11-16 km al norte de La Paz Centro.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Reserva Natural Península de León', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/3RbFMeVVNx6HgfAX7';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/leon7.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
