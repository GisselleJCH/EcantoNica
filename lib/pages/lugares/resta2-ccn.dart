...
void main() {
  runApp(const resccn2());
}

class resccn2 extends StatelessWidget {
  const resccn2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un restaurante elegante que ofrece cocina caribeña e internacional en un ambiente moderno y sofisticado. Ideal para una cena especial o una ocasión romántica.',
      'Abierto de martes a domingo de 12:00 a 15:00 y de 18:00 a 22:00 horas. Cerrado los lunes.',
      'Rango de precios alto.',
      89426789,
      'Frente al mar, Corn Island, Costa Caribe Norte, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Restaurante El Marlin', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/rccn2.jpeg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
