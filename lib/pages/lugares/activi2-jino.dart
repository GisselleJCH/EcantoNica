...
void main() {
  runApp(const actcjino2());
}

class actcjino2 extends StatelessWidget {
  const actcjino2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'La Laguna de Apacelis es un lago de origen volcánico rodeado de un paisaje montañoso. Un sendero te lleva a la orilla de la laguna, donde puedes disfrutar de un paseo en bote, observar aves exóticas y relajarte en un entorno natural único.',
      'Abierto todos los días. Se recomienda llegar temprano en la mañana o al final de la tarde para evitar el calor del sol.',
      'Entrada: US 3.',
      0,
      'A 15 km de Jinotega, Jinotega, Nicaragua',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Laguna de Apacelis', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/actijino2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
