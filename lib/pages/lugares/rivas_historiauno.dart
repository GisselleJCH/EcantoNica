...
void main() {
  runApp(const rivas_historiauno());
}

class rivas_historiauno extends StatelessWidget {
  const rivas_historiauno({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      'Abierto de lunes a domingo de 8:00am a 12:00mm y de 1:00pm a 06:00pm.',
      'Entrada gratuita.',
      0,
      'Centro de la ciudad de Rivas, Rivas, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Catedral de Rivas', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/yENHoXstucKX2G3s7';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/rivas8.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
