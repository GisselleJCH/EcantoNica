...
class paboa1 extends StatelessWidget {
  const paboa1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Centro de la ciudad de Boaco, Boaco, Nicaragua', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/jCe1UDtoAVqtTF8f6 ';
 @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
