...
void main() {
  runApp(const actrio2());
}

class actrio2 extends StatelessWidget {
  const actrio2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'La Laguna de San Carlos es un lago de agua dulce rodeado de un paisaje montañoso. Un sendero te lleva a la orilla de la laguna, donde puedes disfrutar de un paseo en bote, observar aves exóticas y relajarte en un entorno natural único.',
      'Abierto todos los días. Se recomienda llegar temprano en la mañana o al final de la tarde para evitar el calor del sol.',
      'Entrada: US 3.',
      71726789,
      'A 10 km de San Carlos, San Carlos, Río San Juan, Nicaragua.',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Laguna de San Carlos', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/actrio2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
