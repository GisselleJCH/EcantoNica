...
void main() {
  runApp(const acteste2());
}

class acteste2 extends StatelessWidget {
  const acteste2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'A 20 km de Estelí, Estelí, Nicaragua.',
      'La Laguna de La Blanquita es un lago de cráter rodeado de bosque nuboso. Un sendero te lleva a la orilla de la laguna, donde puedes disfrutar de un paseo en bote, observar aves exóticas y relajarte en un entorno natural único.',
      'Abierto todos los días. Se recomienda llegar temprano en la mañana o al final de la tarde para evitar el calor del sol.',
      'Entrada: US 3.',
      0,
      'A 20 km de Esteli, Nicaragua.',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Laguna de La Blanquita', negocio: negocio),
    );
  }
}
