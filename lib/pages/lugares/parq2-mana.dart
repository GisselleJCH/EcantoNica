...
void main() {
  runApp(const parman2());
}

class parman2 extends StatelessWidget {
  const parman2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un parque dedicado al ex presidente de Panamá, Omar Torrijos, con un monumento en su honor, áreas verdes, juegos infantiles y un kiosko para eventos. Ideal para pasar un día en familia o hacer un picnic.',
      'Abierto las 24 horas del día, los 7 días de la semana.',
      'Entrada gratuita.',
      0,
      'Barrio Las Colinas, Managua, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Omar Torrijos', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/fDDHtiC5BsvdLTLLA ';
 @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/pman2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
