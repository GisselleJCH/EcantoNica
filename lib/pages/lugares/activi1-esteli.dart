...
void main() {
  runApp(const acteste1());
}

class acteste1 extends StatelessWidget {
  const acteste1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'A 15 km de Estelí, Estelí, Nicaragua',
      'La Reserva Natural Miraflor alberga una gran variedad de flora y fauna, incluyendo bosques nubosos, cascadas y miradores con vistas panorámicas. Disfruta de senderismo, observación de aves, ciclismo y otras actividades al aire libre.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Reserva Natural Miraflor', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/JshyWP7Z8WXx2Uph7 ';
  @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/re1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
