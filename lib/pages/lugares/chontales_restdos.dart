...
void main() {
  runApp(const chontales_restdos());
}

class chontales_restdos extends StatelessWidget {
  const chontales_restdos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Restaurante Las Cabañas',
      'Un restaurante rústico con vista a las montañas que ofrece una variedad de platos nicaragüenses e internacionales. Disfruta de un ambiente tranquilo y familiar mientras degustas comida deliciosa.',
      'Abre de viernes a domingo de 12:00mm - 10:00pm',
      'Rango de precios medio.',
      87896789,
      'Ubicado a 2 km del centro de Chontales, Nicaragua.',
      '',
      '',
      ''
    );
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/1GueJaQebwH8w1Xv6';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chontales2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
