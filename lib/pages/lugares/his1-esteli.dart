...
class heste1 extends StatelessWidget {
  const heste1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un museo dedicado a la vida y obra del poeta nicaragüense Gregorio Urbano Gilbert, con una colección de sus poemas, objetos personales y otros objetos de interés histórico. Aprende sobre la vida y legado de este importante poeta nicaragüense.',
      'Abierto de martes a domingo de 8:00 a 12:00 y de 13:00 a 17:00 horas. Cerrado los lunes.',
      'Entrada: US 1.',
      0,
      'Barrio Monseñor Lezcano, Estelí, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Museo Gregorio Urbano Gilbert', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/6oDShnWvChfRmXYn8 ';
 @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/mu1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
