...
void main() {
  runApp(const granada_actividaduno());
}

class granada_actividaduno extends StatelessWidget {
  const granada_actividaduno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Bicicleta - Andemos, Tours & Bikes ',
      'Somos una tour operadora que brinda una perspectiva diferente de la ciudad de Granada.',
      'Abre de lunes a domingo, 08:00am-06:00pm',
      '',
      86942014,
      'Ubicado en calle el caimito de la alcaldia 1c1/2 al este, Granada, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Bicicleta - Andemos, Tours & Bikes', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/D6bPc7isqbP1iADj6';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/granada3.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
