...
void main() {
  runApp(const parrio1());
}

class parrio1 extends StatelessWidget {
  const parrio1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      'Entrada gratuita.',
      0,
      'Centro de la ciudad de San Carlos, San Carlos, Río San Juan, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Central de San Carlos', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/jr5oKskYLf2WE4oT9';
 @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/parsan1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
