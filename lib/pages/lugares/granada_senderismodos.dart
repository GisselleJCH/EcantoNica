...
void main() {
  runApp(const granada_senderismodos());
}

class granada_senderismodos extends StatelessWidget {
  const granada_senderismodos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Mirador de Posintepe',
      'Un mirador con vistas panorámicas del Lago Cocibolca y la ciudad de Granada. Un lugar perfecto para tomar fotos y disfrutar de las vistas.',
      'Abierto de Lunes a Domingo.',
      '',
      0,
      'Se encuentra ubicado Granada, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Mirador de Posintepe', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/czWvg2uM4bGPA5M88';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/granada8.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
