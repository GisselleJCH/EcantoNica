...
void main() {
  runApp(const matagalpa_restuno());
}

class matagalpa_restuno extends StatelessWidget {
  const matagalpa_restuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Mi Marisquería',
      'Un restaurante de todo tipo de mariscos.',
      'Abre de lunes a domingo, 10:00am-09:00pm.',
      '',
      23404315,
      'Reparto la Florida, del plantel San Miguel media cuadra al sur, Matagalpa',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Mi Marisquería', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/jbiJx7HT67JcweB77';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/ma1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
