...
void main() {
  runApp(const sendemana1());
}

class sendemana1 extends StatelessWidget {
  const sendemana1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un sendero te lleva a la Cascada de Chiltepe, donde podrás refrescarte en sus aguas cristalinas y disfrutar de la belleza natural del lugar. Relájate bajo la cascada, toma fotos y respira aire puro.',
      'Abierto todos los días. Se recomienda llegar temprano en la mañana o al final de la tarde para evitar el calor del sol.',
      'Entrada gratuita.',
      0,
      'A 15 km de Managua, Managua, Nicaragua.',
      'Fácil.',
      'Aproximadamente 1 horas de ida y vuelta.',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cascada de Chiltepe: Un tesoro natural en Managua', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/UJFiERHWktmSuR8x7 ';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/sman1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
