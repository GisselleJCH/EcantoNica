...
void main() {
  runApp(const chontales_actividaddos());
}

class chontales_actividaddos extends StatelessWidget {
  const chontales_actividaddos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Mirador de Chontales',
      'Un sendero corto te lleva al Mirador de Chontales, donde podrás disfrutar de impresionantes vistas panorámicas del municipio, las montañas y el valle circundante. Un lugar perfecto para observar la puesta de sol y tomar fotografías memorables.',
      'Abre todos los días.',
      'Entrada gratuita.',
      0,
      'Ubicado a 4 km del centro de Chontales, Nicaragua.',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Mirador de Chontales', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/ynJSdz9PN74KY2sM9';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chontales4.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
