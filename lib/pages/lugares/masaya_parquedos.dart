...
void main() {
  runApp(const masaya_parquedos());
}

class masaya_parquedos extends StatelessWidget {
  const masaya_parquedos({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Central Masaya', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.google.com/?cid=14766768694236273690';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/masaya4.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
