...
void main() {
  runApp(const hriosan1());
}

class hriosan1 extends StatelessWidget {
  const hriosan1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un museo que alberga una colección de piezas arqueológicas, objetos históricos y culturales de la región. Aprende sobre la historia, tradiciones y costumbres de Río San Juan.',
      'Abierto de martes a domingo de 8:00 a 12:00 y de 13:00 a 17:00 horas. Cerrado los lunes.',
      'Entrada: US 1.',
      0,
      'Barrio Monseñor Lezcano, San Carlos, Río San Juan, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Museo Regional de San Carlos', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/hriosan1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
