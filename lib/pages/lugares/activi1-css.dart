...
void main() {
  runApp(const actccs1());
}

class actccs1 extends StatelessWidget {
  const actccs1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'La Reserva de Biósfera Indio Maíz es la segunda reserva de selva tropical más grande del hemisferio occidental y alberga una gran variedad de flora y fauna, incluyendo jaguares, monos y tapires. Disfruta de senderismo, observación de aves, paseos en bote y otras actividades al aire libre en este entorno natural único.',
      'Abierto todos los días. Se recomienda llegar temprano en la mañana o al final de la tarde para evitar el calor del sol.',
      'Entrada: US 10.',
      0,
      'A 80 km de Bluefields, Bluefields, Costa Caribe Sur, Nicaragua.',
      'Varía según la actividad elegida',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Reserva de Biósfera Indio Maíz', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/cWMKPtdpAap5vDjf8';
  @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/actccs1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
