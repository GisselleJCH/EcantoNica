...
void main() {
  runApp(const senriosan1());
}

class senriosan1 extends StatelessWidget {
  const senriosan1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'El Cerro El Hormiguero ofrece una caminata desafiante pero gratificante hasta la cima. Disfruta de vistas panorámicas impresionantes del paisaje circundante, observa la flora y fauna local y respira aire puro.',
      'Abierto todos los días. Se recomienda iniciar la caminata temprano por la mañana.',
      '',
      0,
      'A 20 km de San Carlos, San Carlos, Río San Juan, Nicaragua.',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cerro El Hormiguero', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/yFs6BXWGzBGxFewi7 ';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/parsan2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
