...
void main() {
  runApp(const chontales_senderismos());
}

class chontales_senderismos extends StatelessWidget {
  const chontales_senderismos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Laguna de Chontales',
      'Un sendero te lleva a la Laguna de Chonatles, un oasis de tranquilidad rodeado de bosque nuboso. Disfruta de la belleza natural del lugar, observa aves exóticas y respira aire puro.',
      'Abierto de Lunes a Domingo.',
      'Entrada gratuita.',
      0,
      'A 7 km del centro de Chontales, Nicaragua.',
      'Moderado.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Laguna de Chontales', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/WTGj6sfNonsMAVvR9';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chontales7.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
