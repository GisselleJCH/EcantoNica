...
void main() {
  runApp(const leon_parques());
}

class leon_parques extends StatelessWidget {
  const leon_parques({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Parque Zoológico de León',
      'Un zoológico con una variedad de animales de diferentes partes del mundo.',
      'Abre de lunes a domingo, 08am-05pm',
      'Precio de entrada: Adultos: 80 córdobas, Niños: 40 córdobas.',
      0,
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Zoológico de León', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/XJ3XjRjMECugZjLA6';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/leon5.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
