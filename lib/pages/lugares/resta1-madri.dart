...
void main() {
  runApp(const resmadr1());
}

class resmadr1 extends StatelessWidget {
  const resmadr1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un restaurante familiar que sirve platos típicos nicaragüenses en un ambiente acogedor y hogareño. Disfruta de una deliciosa vaquita, un plato de nacatamales o un rico vigorón.',
      'Abierto de lunes a domingo de 7:00 a 22:00 horas.',
      'Rango de precios bajo.',
      97723456,
      'Contiguo al parque central de Somoto, Somoto, Madriz, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Restaurante El Fogón Somoto', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/f9B8bJv27uVe3Rt28 ';
 @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/r1madriz.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
