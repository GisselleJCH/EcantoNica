...
void main() {
  runApp(const chontales_deporteuno());
}

class chontales_deporteuno extends StatelessWidget {
  const chontales_deporteuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Campo de Fútbol Municipal de Chontales',
      'Un campo de fútbol donde se celebran partidos locales y ligas comunitarias. Si te gusta el fútbol, puedes jugar con los lugareños o simplemente disfrutar de un partido.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Campo de Fútbol Municipal de Chontales', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.app.goo.gl/WgK1D1edruC7VohF8';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chontales8.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
