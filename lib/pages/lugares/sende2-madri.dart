...
void main() {
  runApp(const sendemadri2());
}

class sendemadri2 extends StatelessWidget {
  const sendemadri2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un sendero te lleva a las Cascadas de La Flor, donde podrás refrescarte en sus aguas cristalinas y disfrutar de la belleza natural del lugar. Relájate bajo la cascada, toma fotos y respira aire puro.',
      'Abierto todos los días. Se recomienda llegar temprano en la mañana o al final de la tarde para evitar el calor del sol.',
      'Entrada gratuita.',
      71726789,
      'A 30 km de Somoto, Somoto, Madriz, Nicaragua.',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cascadas de La Flor: Un oasis de frescura en Madriz', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/senmadri2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
