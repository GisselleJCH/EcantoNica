...
class hji2 extends StatelessWidget {
  const hji2({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      'Entrada gratuita.',
      0,
      'Centro de la ciudad de Jinotega, Jinotega, Nicaragua.',
      '',
      '',
      ''
    );
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/KiAux9eynWDnNLeq9 ';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/his2jino.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
