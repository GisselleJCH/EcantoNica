...
void main() {
  runApp(const parest1());
}

class parest1 extends StatelessWidget {
  const parest1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      'Entrada gratuita.',
      0,
      'Centro de la ciudad de Estelí, Estelí, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Central de Estelí', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/DkGA4iUp9Bovipy36 ';
  @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/par1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
