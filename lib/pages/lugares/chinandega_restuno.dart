...
void main() {
  runApp(const chinandega_restuno());
}

class chinandega_restuno extends StatelessWidget {
  const chinandega_restuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Restaurante hong Kong',
      'Ofrece cocina china y es conocido por su buena atención y ambiente agradable. También tienen opciones de comida para llevar.',
      'Lunes a Domingo, de 10:00 AM a 10:00 PM',
      '',
      23413856,
      'Ubicado en Chinandega, Chinandega, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Restaurante Hong Kong', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/Xiug9f8fnrHXowrA9';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chi1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
