...
void main() {
  runApp(const granada_senderismouno());
}

class granada_senderismouno extends StatelessWidget {
  const granada_senderismouno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Lago Cocibolca',
      'Un lago volcánico grande y hermoso con vistas impresionantes. Un lugar popular para practicar senderismo, acampar y pescar.',
      'Abierto de Lunes a Domingo.',
      '',
      0,
      'Se encuentra ubicado en Granada, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Lago Cocibolca', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/oibERFS25xuE42w2A';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/granada7.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
