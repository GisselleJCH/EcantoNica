...
void main() {
  runApp(const parmadr1());
}

class parmadr1 extends StatelessWidget {
  const parmadr1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      'Entrada gratuita.',
      0,
      'Centro de la ciudad de Somoto, Somoto, Madriz, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Central de Somoto', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/FQ9g5wtuivM6Wwea9 ';
  @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/parmadri1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
