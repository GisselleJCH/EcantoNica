...
class heste2 extends StatelessWidget {
  const heste2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Una imponente iglesia construida en el siglo XIX, que destaca por su arquitectura colonial y su fachada ornamentada. Admira su interior majestuoso y conoce su historia religiosa.',
      'Abierto de lunes a domingo de 8:00 a 12:00 y de 14:00 a 18:00 horas.',
      'Entrada gratuita.',
      0,
      'Barrio San Francisco, Estelí, Nicaragua',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Iglesia San Francisco de Asís', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/1Ts4JQPLhy9D93yR9 ';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/mu2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
