...
void main() {
  runApp(const acmadri2());
}

class acmadri2 extends StatelessWidget {
  const acmadri2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Las Cascadas de La Chorcha son un conjunto de cascadas que se pueden visitar a través de un sendero. Disfruta de un refrescante baño en las cascadas, observa la belleza natural del lugar y toma fotos.',
      'Abierto todos los días. Se recomienda llegar temprano en la mañana o al final de la tarde para evitar el calor del sol.',
      'Entrada: US 3.',
      0,
      'A 15 km de Somoto, Somoto, Madriz, Nicaragua.',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cascadas de La Chorcha', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/actimadri2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
