...
class hsego2 extends StatelessWidget {
  const hsego2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Una imponente catedral construida en el siglo XIX, que destaca por su arquitectura colonial y su fachada ornamentada. Admira su interior majestuoso y conoce su historia religiosa.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Catedral Inmaculada Concepción de María', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/bX8aDZLSUGTF8tzN8 ';
 @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/musego2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
