...
void main() {
  runApp(const masaya_historiados());
}

class masaya_historiados extends StatelessWidget {
  const masaya_historiados({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Casa Museo Camilo Ortega',
      'Un museo dedicado a la vida y obra de Camilo Ortega, un líder revolucionario nicaragüense.',
      'Lunes a Domingo 09:00am - 09:00pm',
      'Gratis.',
      0,
      'Museo camilo ortega 2cuadra ariba y media al, sur.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Casa Museo Camilo Ortega', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.google.com/?cid=6211991291507806411';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/masaya10.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
