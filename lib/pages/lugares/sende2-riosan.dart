...
void main() {
  runApp(const senriosan2());
}

class senriosan2 extends StatelessWidget {
  const senriosan2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un sendero te lleva a las Cascadas El Dorado, donde podrás refrescarte en sus aguas cristalinas y disfrutar de la belleza natural del lugar. Relájate bajo la cascada, toma fotos y respira aire puro.',
      'Abierto todos los días. Se recomienda llegar temprano en la mañana o al final de la tarde para evitar el calor del sol.',
      'Entrada gratuita.',
      0,
      'A 30 km de San Carlos, San Carlos, Río San Juan, Nicaragua',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cascadas El Dorado: Un paraíso escondido en Río San Juan', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/senrio1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
