...
void main() {
  runApp(const deeste2());
}

class deeste2 extends StatelessWidget {
  const deeste2({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      0,
      'Barrio San Juan, Estelí, Nicaragua.',
      '',
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/de2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
