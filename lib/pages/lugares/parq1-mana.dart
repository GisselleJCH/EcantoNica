...
void main() {
  runApp(const parman1());
}

class parman1 extends StatelessWidget {
  const parman1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Luis Alfonso Vanegas', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/U5wsZ26jJ67A4L6k6 ';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/pman.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
