...
void main() {
  runApp(const masaya_restuno());
}

class masaya_restuno extends StatelessWidget {
  const masaya_restuno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'El Arabe',
      'Un restaurante de comida árabe con un ambiente acogedor y una amplia variedad de platos deliciosos',
      'Lunes a Domingo de 12-9pm',
      '',
      76507578,
      'Policía nac 50vrs este, Masaya, Nicaragua.',
      '',
      '',
      'Ofrece comida en hora feliz · Ofrece platos veganos · Tiene Wi-Fi'
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'El Arabe', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  final String googleMapsUrl = 'https://maps.google.com/?cid=10015504562523344957';
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/masaya1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
           ...
           _buildSection('Teléfono', negocio.telefonos!.toString()),
            const SizedBox(height: 10),
            _buildSection('Opciones de Servicio', negocio.servicio!),
            const SizedBox(height: 10),
            _buildReviewSection(),
            const SizedBox(height: 20),
