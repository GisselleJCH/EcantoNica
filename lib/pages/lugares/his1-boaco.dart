...
void main() {
  runApp(const hisboa1());
}

class hisboa1 extends StatelessWidget {
  const hisboa1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un museo que alberga una colección de piezas arqueológicas, objetos históricos y culturales de la región. Aprende sobre la historia, tradiciones y costumbres de Boaco.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Museo Regional de Boaco', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/pcnLVKTayVM89hJM8 ';
 @override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/ms1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
