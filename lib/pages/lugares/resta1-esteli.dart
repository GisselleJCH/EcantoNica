...
class rseta1 extends StatelessWidget {
  const rseta1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final negocio = Negocio(
      ...
      71723456,
      'Contiguo al parque central de Estelí, Estelí, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Restaurante El Portón', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/r1este.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
