...
class senj2 extends StatelessWidget {
  const senj2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un sendero te lleva a las Cascadas de Piloca, donde podrás refrescarte en sus aguas cristalinas y disfrutar de la belleza natural del lugar. Relájate bajo la cascada, toma fotos y respira aire puro',
      'Abierto todos los días. Se recomienda llegar temprano en la mañana o al final de la tarde para evitar el calor del sol.',
      'Entrada gratuita.',
      71726789,
      'A 30 km de Jinotega, Jinotega, Nicaragua.',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cascadas de Piloca: Un paraíso escondido en Jinotega', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/sendejino2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
