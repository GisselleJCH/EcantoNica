...
class rsan1 extends StatelessWidget {
  const rsan1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un restaurante familiar que sirve platos típicos nicaragüenses en un ambiente acogedor y hogareño. Disfruta de un delicioso guiso de garrobo, un plato de rondón o un rico vaho de pescado.',
      'Abierto de lunes a domingo de 7:00 a 22:00 horas.',
      'Rango de precios bajo.',
      89723456,
      'Calle principal, El Castillo, Río San Juan, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Restaurante El Castillo', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
 ...
 final String googleMapsUrl = 'https://maps.app.goo.gl/kDpA1KNcNLA3EiVk9 ';
@override
  void initState() {
    super.initState();
    _loadFavoriteStatus();
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/rsan1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
