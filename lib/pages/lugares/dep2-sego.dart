...
void main() {
  runApp(const desego2());
}

class desego2 extends StatelessWidget {
  const desego2({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Complejo Deportivo Gregorio Urbano Gilbert', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/depo2sego.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
