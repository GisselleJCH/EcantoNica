...
void main() {
  runApp(const resccn1());
}

class resccn1 extends StatelessWidget {
  const resccn1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un restaurante familiar que sirve platos típicos de la cocina misquita, incluyendo rondón, wina y guifiti. Disfruta de los sabores únicos de la región en un ambiente acogedor y hogareño.',
      'Abierto de lunes a domingo de 7:00 a 22:00 horas.',
      'Rango de precios bajo.',
      89423456,
      'Barrio El Porvenir, Bilwi, Puerto Cabezas, Costa Caribe Norte, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Restaurante Miss Patty', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/rccn1.jpeg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
