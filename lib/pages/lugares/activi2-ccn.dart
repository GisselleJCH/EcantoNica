...
class actcc2 extends StatelessWidget {
  const actcc2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'La Laguna de Wawa es un lago de agua dulce rodeado de un paisaje montañoso. Un sendero te lleva a la orilla de la laguna, donde puedes disfrutar de un paseo en bote, observar aves exóticas y relajarte en un entorno natural único.',
      'Abierto todos los días. Se recomienda llegar temprano en la mañana o al final de la tarde para evitar el calor del sol.',
      'Entrada: US 5.',
      0,
      'A 40 km de Bilwi, Puerto Cabezas, Costa Caribe Norte, Nicaragua.',
      'Facil',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Laguna de Wawa', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/actccn2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
