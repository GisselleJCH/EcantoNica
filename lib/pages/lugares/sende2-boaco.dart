...
void main() {
  runApp(const sboaco2());
}

class sboaco2 extends StatelessWidget {
  const sboaco2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un sendero te lleva a las Cascadas de La Estancia, donde podrás refrescarte en sus aguas cristalinas y disfrutar de la belleza natural del lugar. Relájate bajo la cascada, toma fotos y respira aire puro.',
      'Abierto todos los días. Se recomienda llegar temprano en la mañana o al final de la tarde para evitar el calor del sol.',
      'Entrada gratuita.',
      71726789,
      'A 25 km de Boaco, Boaco, Nicaragua',
      'Fácil.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cascadas de La Estancia', negocio: negocio),
    );
  }
}
