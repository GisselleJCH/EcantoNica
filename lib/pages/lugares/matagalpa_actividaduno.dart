...
void main() {
  runApp(const matagalpa_actividaduno());
}

class matagalpa_actividaduno extends StatelessWidget {
  const matagalpa_actividaduno({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Reserva Natural Cerro Apó',
      'La Reserva Natural Cerro Apó alberga el pico más alto de Nicaragua, el Cerro Apó, y ofrece una variedad de senderos para caminar con diferentes niveles de dificultad. Disfruta de impresionantes vistas panorámicas, observa la flora y fauna local y respira aire puro.',
      'Lunes a Domingo. 08am-06pm',
      '5 dólares',
      0,
      'A 17 km de Matagalpa, Matagalpa, Nicaragua.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Reserva Natural Cerro Apó', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/ntyL5cdA6gp4Qo459';
