...
void main() {
  runApp(const matagalpa_deportes());
}

class matagalpa_deportes extends StatelessWidget {
  const matagalpa_deportes({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Estadio Municipal Chale Solís',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Estadio Municipal Chale Solís', negocio: negocio,),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/doTfK9u4uVxR4iUR8';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/ma7.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
