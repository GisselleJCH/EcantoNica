...
void main() {
  runApp(const sendeccn2());
}

class sendeccn2 extends StatelessWidget {
  const sendeccn2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      '',
      'Un sendero fácil que te lleva a la orilla de la Laguna de Wawa, donde puedes disfrutar de un paseo en bote, observar aves exóticas y relajarte en un entorno natural único.',
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Sendero Laguna de Wawa', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/sccn2.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
