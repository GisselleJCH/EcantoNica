...
class parj1 extends StatelessWidget {
  const parj1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Parque Central de Jinotega', negocio: negocio),
    );
  }
}
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/parjino1.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
