...
void main() {
  runApp(const chontales_deportedos());
}

class chontales_deportedos extends StatelessWidget {
  const chontales_deportedos({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final negocio = Negocio(
      'Cancha Municipal de Baloncesto de Chontales',
      'Una cancha de baloncesto donde se celebran juegos locales y torneos. Si te gusta el baloncesto, puedes jugar con los lugareños o simplemente ver un partido.',
      'Varía según los eventos deportivos.',
      '',
      0,
      'Ubicado contiguo al Parque Central de Chontales, Nicaragua.',
      '',
      '',
      ''
    );
    ...
    return MaterialApp(
      ...
      home: RestaurantePage(title: 'Cancha Municipal de Baloncesto de Chontales', negocio: negocio),
    );
  }
}
...
class _RestaurantePageState extends State<RestaurantePage> {
  ...
  final String googleMapsUrl = 'https://maps.app.goo.gl/bgp75VdPkWzQvfy5A';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/chontales9.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
