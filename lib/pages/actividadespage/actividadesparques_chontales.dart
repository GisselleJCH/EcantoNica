...
import 'package:barra/pages/lugares/chontales_parquedos.dart';
import 'package:barra/pages/lugares/chontales_parqueuno.dart';


void main() {
  runApp(const actividadesparques_chontales(title: '',));
}

class actividadesparques_chontales extends StatelessWidget {
  const actividadesparques_chontales({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => chontales_parqueuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => chontales_parquedos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/chontales5.jpg', 'Parque Central de Chontales', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/chontales6.jpg', 'Parque Ecológico Chontales', '/actividadDos'),
              ],
            ),
          ),
        ],
