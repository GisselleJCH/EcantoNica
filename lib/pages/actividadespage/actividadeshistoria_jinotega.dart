...
import 'package:barra/pages/lugares/his1-jino.dart';
import 'package:barra/pages/lugares/his2-jino.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const hisjino(title: ''),
    );
  }
}

class hisjino extends StatefulWidget {
  const hisjino({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<hisjino> createState() => _HistJinotegaState();
}

class _HistJinotegaState extends State<hisjino> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/his1jino.jpg', 'Museo Regional de Jinotega', () {
                  // Acción del botón "Ver más" para Museo Regional de Jinotega
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => hji1()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/his2jino.jpg', 'Catedral Inmaculada Concepción de María', () {
                  // Acción del botón "Ver más" para Catedral Inmaculada Concepción de María
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => hji2()),
                  );
                }),
              ],
            ),
