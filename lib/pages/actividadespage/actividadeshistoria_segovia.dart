...
import 'package:barra/pages/lugares/his1-sego.dart';
import 'package:barra/pages/lugares/his2-sego.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Hissego(title: ''),
    );
  }
}

class Hissego extends StatefulWidget {
  const Hissego({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<Hissego> createState() => _HissegoState();
}

class _HissegoState extends State<Hissego> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/musego1.jpg', 'Museo Regional de Ocotal', () {
                  // Acción del botón "Ver más" para Museo Regional de Ocotal
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => hsego1()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/musego2.jpg', 'Catedral Inmaculada Concepción de María', () {
                  // Acción del botón "Ver más" para Catedral Inmaculada Concepción de María
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => hsego2()),
                  );
                }),
              ],
            ),
