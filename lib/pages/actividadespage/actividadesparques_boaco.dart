...
import 'package:barra/pages/lugares/parq1-boaco.dart';
import 'package:barra/pages/lugares/parq2-boaco.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Parqboaco(title: ''),
    );
  }
}

class Parqboaco extends StatefulWidget {
  const Parqboaco({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<Parqboaco> createState() => _ParqboacoState();
}

class _ParqboacoState extends State<Parqboaco> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/p1.jpg', 'Parque Central de Boaco', () {
                  // Acción del botón "Ver más" para Parque Central de Boaco
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => paboa1()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/p2.jpg', 'Parque Rubén Darío', () {
                  // Acción del botón "Ver más" para Parque Rubén Darío
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => paboa2()),
                  );
                }),
              ],
            ),
