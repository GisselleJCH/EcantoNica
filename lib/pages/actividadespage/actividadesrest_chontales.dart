...
import 'package:barra/pages/lugares/chontales_restuno.dart';
import 'package:barra/pages/lugares/chontales_restdos.dart';

void main() {
  runApp(const actividadesrest_chontales(title: 'restchontales',));
}

class actividadesrest_chontales extends StatelessWidget {
  const actividadesrest_chontales({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => chontales_restuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => chontales_restdos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/chontales1.jpg', 'Restaurante La Esquina', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/chontales2.jpg', 'Restaurante Las Cabañas', '/actividadDos'),
              ],
            ),
          ),
        ],
