...
import 'package:barra/pages/lugares/chinandega_historiauno.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadeshistoria_chinandega(title: '',));
}

class actividadeshistoria_chinandega extends StatelessWidget {
  const actividadeshistoria_chinandega({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => chinandega_historiauno(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/chi11.jpg', 'Catedral de Chinandega', '/actividadUno'),
