import 'package:barra/pages/lugares/granada_historiados.dart';
import 'package:barra/pages/lugares/granada_historiauno.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadeshistoria_granada(title: '',));
}

class actividadeshistoria_granada extends StatelessWidget {
  const actividadeshistoria_granada({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => granada_historiauno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => granada_historiados(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/granada10.jpg', 'Catedral de Granada', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/granada11.jpg', 'Convento e Iglesia de San Francisco', '/actividadDos'),
              ],
            ),
          ),
        ],
