...
import 'package:barra/pages/lugares/diriamba_actividaddos.dart';
import 'package:barra/pages/lugares/diriamba_actividaduno.dart';

void main() {
  runApp(const actividadesact_diriamba(title: 'actdiriamba',));
}

class actividadesact_diriamba extends StatelessWidget {
  const actividadesact_diriamba({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => diriamba_actividaduno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => diriamba_actividaddos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/diriamba3.jpg', 'Finca el Madroñal', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/diriamba4.jpg', 'Reserva Concepción de Maria', '/actividadDos'),
              ],
            ),
          ),
        ],
