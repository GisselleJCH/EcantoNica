...
import 'package:barra/pages/lugares/rivas_restdos.dart';
import 'package:barra/pages/lugares/rivas_restuno.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadesrest_rivas(title: '',));
}

class actividadesrest_rivas extends StatelessWidget {
  const actividadesrest_rivas({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => rivas_restuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => rivas_restdos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/rivas1.jpg', 'La Nani Café', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/rivas2.jpg', 'La Parrilla Drinks & Food', '/actividadDos'),
              ],
            ),
          ),
        ],
