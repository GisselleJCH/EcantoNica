...
import 'package:barra/pages/lugares/masaya_restdos.dart';
import 'package:barra/pages/lugares/masaya_restuno.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadesrest_masaya(title: 'restmasaya',));
}

class actividadesrest_masaya extends StatelessWidget {
  const actividadesrest_masaya({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => masaya_restuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => masaya_restdos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/masaya1.jpg', 'El Arabe', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/masaya2.jpg', 'El Crustaceo', '/actividadDos'),
              ],
            ),
          ),
        ],
