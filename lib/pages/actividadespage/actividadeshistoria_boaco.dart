...
import 'package:barra/pages/lugares/his1-boaco.dart';
import 'package:barra/pages/lugares/his2-boaco.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const histoboaco(title: ''),
    );
  }
}

class histoboaco extends StatefulWidget {
  const histoboaco({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<histoboaco> createState() => _HistoboacoState();
}

class _HistoboacoState extends State<histoboaco> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/ms1.jpg', 'Museo Regional de Boaco', () {
                  // Acción del botón "Ver más" para Museo Regional de Boaco
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => hisboa1()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/ms2.jpg', 'Iglesia San José de Boaco', () {
                  // Acción del botón "Ver más" para Iglesia San José de Boaco
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => hisboa2()),
                  );
                }),
              ],
            ),
