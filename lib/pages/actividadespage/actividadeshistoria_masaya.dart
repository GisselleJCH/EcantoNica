...
import 'package:barra/pages/lugares/masaya_historiados.dart';
import 'package:barra/pages/lugares/masaya_historiauno.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadeshistoria_masaya(title: '',));
}

class actividadeshistoria_masaya extends StatelessWidget {
  const actividadeshistoria_masaya({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => masaya_historiauno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => masaya_historiados(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/masaya9.jpg', 'Antigua Estación de Ferrocarril', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/masaya10.jpg', 'Casa Museo Camilo Ortega', '/actividadDos'),
              ],
            ),
          ),
        ],
