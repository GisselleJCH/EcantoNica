import 'package:barra/pages/lugares/granada_parquedos.dart';
import 'package:barra/pages/lugares/granada_parqueuno.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesparques_granada(title: '',));
}

class actividadesparques_granada extends StatelessWidget {
  const actividadesparques_granada({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => granada_parqueuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => granada_parquedos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/granada5.jpg', 'Parque Central de Granada', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/granada6.jpg', 'Parque Xalteva', '/actividadDos'),
              ],
            ),
          ),
        ],
