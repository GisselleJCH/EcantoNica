import 'package:barra/pages/lugares/diriamba_historiados.dart';
import 'package:barra/pages/lugares/diriamba_historiauno.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadeshistoria_diriamba(title: '',));
}

class actividadeshistoria_diriamba extends StatelessWidget {
  const actividadeshistoria_diriamba({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => diriamba_historiauno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => diriamba_historiados(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/diriamba9.jpg', 'Basílica Menor de San Sebastián', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/diriamba10.jpg', 'Reloj Público de Diriamba', '/actividadDos'),
              ],
            ),
          ),
        ],
