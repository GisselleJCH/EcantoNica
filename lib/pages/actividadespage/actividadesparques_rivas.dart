...
import 'package:barra/pages/lugares/rivas_parques.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadesparques_rivas(title: '',));
}

class actividadesparques_rivas extends StatelessWidget {
  const actividadesparques_rivas({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => rivas_parques(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/rivas5.jpg', 'Parque Central de Rivas', '/actividadUno'),
