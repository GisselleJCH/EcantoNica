...
import 'package:barra/pages/lugares/rivas_deportes.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadesdeportes_rivas(title: '',));
}

class actividadesdeportes_rivas extends StatelessWidget {
  const actividadesdeportes_rivas({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => rivas_deportes(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/rivas7.jpg', 'Estadio Yamil Rios Ugarte', '/actividadUno'),
