...
import 'package:barra/pages/lugares/sende1-sego.dart';
import 'package:barra/pages/lugares/sende2-sego.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Sendesego(title: ''),
    );
  }
}

class Sendesego extends StatefulWidget {
  const Sendesego({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<Sendesego> createState() => _SendesegoState();
}

class _SendesegoState extends State<Sendesego> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/parq1sego.jpg', 'Cerro Mogoton', () {
                  // Acción del botón "Ver más" para Cerro Mogoton
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => sendesego1()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/parq2sego.jpg', 'Cascadas de Apacelis', () {
                  // Acción del botón "Ver más" para Cascadas de Apacelis
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => sendesego2()),
                  );
                }),
                const SizedBox(height: 20),
