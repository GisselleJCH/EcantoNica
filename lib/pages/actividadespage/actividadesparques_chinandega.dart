...
import 'package:barra/pages/lugares/chinandega_parquedos.dart';
import 'package:barra/pages/lugares/chinandega_parqueuno.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesparques_chinandega(title: '',));
}

class actividadesparques_chinandega extends StatelessWidget {
  const actividadesparques_chinandega({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: ''),
       routes: {
        '/actividadUno': (context) => chinandega_parquedos(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => chinandega_parqueuno(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/chi5.jpg', 'Parque Central de Chinandega', '/actividadDos'),
                const SizedBox(height: 20),
                buildContainer('assets/chi6.jpg', 'Parque San Antonio', '/actividadUno'),
              ],
            ),
          ),
        ],
