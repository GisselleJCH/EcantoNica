import 'package:barra/pages/lugares/masaya_actividad.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesact_masaya(title: '',));
}

class actividadesact_masaya extends StatelessWidget {
  const actividadesact_masaya({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => masaya_actividad(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/masaya11.jpg', 'Malecón Masaya', '/actividadUno'),
