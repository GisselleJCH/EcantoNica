...
import 'package:barra/pages/lugares/rivas_actividadesdos.dart';
import 'package:barra/pages/lugares/rivas_actividadesuno.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadesact_rivas(title: '',));
}

class actividadesact_rivas extends StatelessWidget {
  const actividadesact_rivas({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => rivas_actividadesuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => rivas_actividadesdos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/rivas3.jpg', 'Volcán concepción', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/rivas4.jpg', 'Reserva Natural Península de Huehuetepe', '/actividadDos'),
              ],
            ),
          ),
        ],
