...
import 'package:barra/pages/lugares/activi1-jino.dart';
import 'package:barra/pages/lugares/activi2-jino.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const actijino(title: ''),
    );
  }
}

class actijino extends StatefulWidget {
  const actijino({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<actijino> createState() => _ActiJinotegaState();
}

class _ActiJinotegaState extends State<actijino> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/actijino1.jpg', 'Reserva Natural Duna de Olomega', () {
                  // Acción del botón "Ver más" para Reserva Natural Duna de Olomega
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => actcjino1()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/actijino2.jpg', 'Laguna de Apacelis', () {
                  // Acción del botón "Ver más" para Laguna de Apacelis
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => actcjino2()),
                  );
                }),
              ],
            ),
