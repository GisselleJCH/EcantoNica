import 'package:barra/pages/lugares/granada_deportes.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesdeportes_granada(title: '',));
}

class actividadesdeportes_granada extends StatelessWidget {
  const actividadesdeportes_granada({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => granada_deportes(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/granada9.jpg', 'Cancha de Fútbol', '/actividadUno'),
