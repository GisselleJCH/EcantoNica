...
import 'package:barra/pages/lugares/parq1-ccn.dart';
import 'package:barra/pages/lugares/parq2-ccn.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Parccn(title: ''),
    );
  }
}

class Parccn extends StatefulWidget {
  const Parccn({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<Parccn> createState() => _ParccnState();
}

class _ParccnState extends State<Parccn> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/pccn1.jpg', 'Parque Central de Bilwi', () {
                  // Acción del botón "Ver más" para Parque Central de Bilwi
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => pccn1 ()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/pccn2.jpg', 'Parque Bananero', () {
                  // Acción del botón "Ver más" para Parque Bananero
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => pccn2 ()),
                  );
                }),
              ],
            ),
