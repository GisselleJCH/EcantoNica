...
import 'package:barra/pages/lugares/matagalpa_historia.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadeshistoria_matagalpa(title: '',));
}

class actividadeshistoria_matagalpa extends StatelessWidget {
  const actividadeshistoria_matagalpa({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => matagalpa_historia(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/ma8.jpg', 'Catedral de Matagalpa', '/actividadUno'),
