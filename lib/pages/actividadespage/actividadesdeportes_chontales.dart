...
import 'package:barra/pages/lugares/chontales_deportedos.dart';
import 'package:barra/pages/lugares/chontales_deporteuno.dart';

void main() {
  runApp(const actividadesdeportes_chontales(title: '',));
}

class actividadesdeportes_chontales extends StatelessWidget {
  const actividadesdeportes_chontales({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => chontales_deporteuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => chontales_deportedos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/chontales8.jpg', 'Campo de Fútbol Municipal de Chontales', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/chontales9.jpg', 'Cancha Municipal de Baloncesto de Chontales', '/actividadDos'),
              ],
            ),
          ),
        ],
