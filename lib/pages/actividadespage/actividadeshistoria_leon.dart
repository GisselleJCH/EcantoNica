import 'package:barra/pages/lugares/leon_historia.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadeshistoria_leon(title: '',));
}

class actividadeshistoria_leon extends StatelessWidget {
  const actividadeshistoria_leon({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: ''),
       routes: {
        '/actividadUno': (context) => leon_historia(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/leon8.jpg', 'La catedral de León de Nicaragua', '/actividadUno'),
