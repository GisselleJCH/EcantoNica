...
import 'package:barra/pages/lugares/his1-esteli.dart';
import 'package:barra/pages/lugares/his2-esteli.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const HistEsteli(title: ''),
    );
  }
}

class HistEsteli extends StatefulWidget {
  const HistEsteli({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<HistEsteli> createState() => _HistEsteliState();
}

class _HistEsteliState extends State<HistEsteli> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/mu1.jpg', 'Museo Gregorio Urbano Gilbert', () {
                  // Acción del botón "Ver más" para Museo Gregorio Urbano Gilbert
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => heste1()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/mu2.jpg', 'Iglesia San Francisco de Asís', () {
                  // Acción del botón "Ver más" para Iglesia San Francisco de Asís
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => heste2()),
                  );
                }),
              ],
            ),
