...
import 'package:barra/pages/lugares/masaya_parquedos.dart';
import 'package:barra/pages/lugares/masaya_parqueuno.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadesparques_masaya(title: '',));
}

class actividadesparques_masaya extends StatelessWidget {
  const actividadesparques_masaya({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => masaya_parqueuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => masaya_parquedos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/masaya3.jpg', 'Parque Natural Masaya', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/masaya4.jpg', 'Parque Central Masaya', '/actividadDos'),
              ],
            ),
          ),
        ],
