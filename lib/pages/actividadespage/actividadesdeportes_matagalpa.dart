...
import 'package:barra/pages/lugares/matagalpa_deportes.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadesdeportes_matagalpa(title: '',));
}

class actividadesdeportes_matagalpa extends StatelessWidget {
  const actividadesdeportes_matagalpa({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => matagalpa_deportes(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/ma7.jpg', 'Estadio Municipal Chale Solís', '/actividadUno'),
