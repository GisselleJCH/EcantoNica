...
import 'package:barra/pages/lugares/activi1-ccn.dart';
import 'package:barra/pages/lugares/activi2-ccn.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const actccn(title: ''),
    );
  }
}

class actccn extends StatefulWidget {
  const actccn({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<actccn> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<actccn> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/actccn1.jpg', 'Reserva de Biósfera Bosawás', () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => actccn1()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/actccn2.jpg', 'Laguna de Wawa', () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => actcc2()),
                  );
                }),
              ],
            ),
