...
import 'package:barra/pages/lugares/activi1-riosan.dart';
import 'package:barra/pages/lugares/activi2-riosan.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const actiriosan(title: ''),
    );
  }
}

class actiriosan extends StatefulWidget {
  const actiriosan({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<actiriosan> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<actiriosan> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/actrio1.jpg', 'Refugio de Vida Silvestre Castillo', () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => actrio1()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/actrio2.jpg', 'Laguna de San Carlos', () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => actrio2()),
                  );
                }),
              ],
            ),
