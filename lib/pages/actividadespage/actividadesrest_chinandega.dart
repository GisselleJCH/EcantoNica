...
import 'package:barra/pages/lugares/chinandega_restdos.dart';
import 'package:barra/pages/lugares/chinandega_restuno.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesrest_chinandega(title: 'restchinandega',));
}

class actividadesrest_chinandega extends StatelessWidget {
  const actividadesrest_chinandega({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: ''),
       routes: {
        '/actividadUno': (context) => chinandega_restuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => chinandega_restdos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/chi1.jpg', 'Restaurante Hong Kong', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/chi2.jpg', 'Pizza Hut', '/actividadDos'),
              ],
            ),
          ),
        ],
