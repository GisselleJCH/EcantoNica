...
import 'package:barra/pages/lugares/chontales_senderismos.dart';

void main() {
  runApp(const actividadessenderismo_chontales(title: '',));
}

class actividadessenderismo_chontales extends StatelessWidget {
  const actividadessenderismo_chontales({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => chontales_senderismos(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/chontales7.jpg', 'Laguna de Chontales', '/actividadUno'),
