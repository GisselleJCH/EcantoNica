import 'package:barra/pages/lugares/diriamba_senderismo.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadessenderismo_diriamba(title: '',));
}

class actividadessenderismo_diriamba extends StatelessWidget {
  const actividadessenderismo_diriamba({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => diriamba_senderismo(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/diriamba7.jpg', 'La Cascada Las Mercedes', '/actividadUno'),
