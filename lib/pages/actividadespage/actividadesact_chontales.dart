...
import 'package:barra/pages/lugares/chontales_actividaddos.dart';
import 'package:barra/pages/lugares/chontales_actividaduno.dart';

void main() {
  runApp(const actividadesact_chontales(title: 'restchontales',));
}

class actividadesact_chontales extends StatelessWidget {
  const actividadesact_chontales({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => chontales_actividaduno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => chontales_actividaddos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/chontales3.jpg', 'Cascadas de Chontales', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/chontales4.jpg', 'Mirador de Chontales', '/actividadDos'),
              ],
            ),
          ),
        ],
