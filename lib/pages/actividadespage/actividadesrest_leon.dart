import 'package:barra/pages/lugares/leon_restdos.dart';
import 'package:barra/pages/lugares/leon_restuno.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesrest_leon(title: 'restleon',));
}

class actividadesrest_leon extends StatelessWidget {
  const actividadesrest_leon({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => leon_restuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => leon_restdos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/leon1.jpg', 'Restaurante El Sesteo', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/leon2.jpg', 'El Bodegón', '/actividadDos'),
              ],
            ),
          ),
        ],
