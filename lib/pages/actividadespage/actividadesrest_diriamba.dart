import 'package:barra/pages/lugares/diriamba_restdos.dart';
import 'package:barra/pages/lugares/diriamba_restuno.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesrest_diriamba(title: 'restdiriamba',));
}

class actividadesrest_diriamba extends StatelessWidget {
  const actividadesrest_diriamba({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => diriamba_restuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => diriamba_restdos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/diriamba1.jpg', 'La Litrógeno', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/diriamba2.jpg', 'Ciscos Bar', '/actividadDos'),
              ],
            ),
          ),
        ],
