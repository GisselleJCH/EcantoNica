import 'package:barra/pages/lugares/leon_parques.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesparques_leon(title: '',));
}

class actividadesparques_leon extends StatelessWidget {
  const actividadesparques_leon({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: ''),
       routes: {
        '/actividadUno': (context) => leon_parques(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/leon5.jpg', 'Parque Zoológico de León', '/actividadUno'),
