...
import 'package:barra/pages/lugares/parq1-mana.dart';
import 'package:barra/pages/lugares/parq2-mana.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Parmanagua(title: ''),
    );
  }
}

class Parmanagua extends StatefulWidget {
  const Parmanagua({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<Parmanagua> createState() => _ParmanaguaState();
}

class _ParmanaguaState extends State<Parmanagua> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/pman.jpg', 'Parque Luis Alfonso Vanegas', () {
                  // Acción del botón "Ver más" para Parque Luis Alfonso Vanegas
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => parman1()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/pman2.jpg', 'Parque Omar Torrijos', () {
                  // Acción del botón "Ver más" para Parque Omar Torrijos
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => parman2()),
                  );
                }),
              ],
            ),
