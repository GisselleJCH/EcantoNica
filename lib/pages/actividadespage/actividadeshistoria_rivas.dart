...
import 'package:barra/pages/lugares/rivas_historiados.dart';
import 'package:barra/pages/lugares/rivas_historiauno.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadeshistoria_rivas(title: '',));
}

class actividadeshistoria_rivas extends StatelessWidget {
  const actividadeshistoria_rivas({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => rivas_historiauno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => rivas_historiados(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/rivas8.jpg', 'Catedral de Rivas', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/rivas9.jpg', 'Museo Regional de Rivas', '/actividadDos'),
              ],
            ),
          ),
        ],
