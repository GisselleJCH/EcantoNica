...
import 'package:barra/pages/lugares/his1-ccn.dart';
import 'package:barra/pages/lugares/his2-ccn.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const hccn(title: ''),
    );
  }
}

class hccn extends StatefulWidget {
  const hccn({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<hccn> createState() => _HccnState();
}

class _HccnState extends State<hccn> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/hccn1.jpg', 'Museo Regional de Puerto Cabezas', () {
                  // Acción del botón "Ver más" para Museo Regional de Puerto Cabezas
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => his1ccn()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/hccn2.jpg', 'Fuerte El Bluff', () {
                  // Acción del botón "Ver más" para Fuerte El Bluff
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => his2ccn()),
                  );
                }),
              ],
            ),
