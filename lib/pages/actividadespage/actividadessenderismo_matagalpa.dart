...
import 'package:barra/pages/lugares/matagalpa_senderismodos.dart';
import 'package:barra/pages/lugares/matagalpa_senderismouno.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadessenderismo_matagalpa(title: '',));
}

class actividadessenderismo_matagalpa extends StatelessWidget {
  const actividadessenderismo_matagalpa({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => matagalpa_senderismouno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => matagalpa_senderismodos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/ma6.jpg', 'Cerro Mogoton', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/ma9.jpg', 'Cascadas de La Luna', '/actividadDos'),
              ],
            ),
          ),
        ],
