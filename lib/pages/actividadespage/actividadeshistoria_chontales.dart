...
import 'package:barra/pages/lugares/chontales_historia.dart';

void main() {
  runApp(const actividadeshistoria_chontales(title: '',));
}

class actividadeshistoria_chontales extends StatelessWidget {
  const actividadeshistoria_chontales({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => chontales_historia(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/chontales10.jpg', 'Museo Comunitario de Chontales', '/actividadUno'),
