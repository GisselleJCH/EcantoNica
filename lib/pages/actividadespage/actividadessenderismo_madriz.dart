...
import 'package:barra/pages/lugares/sende2-madri.dart';
import 'package:barra/pages/lugares/sende1-madri.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Sendemadri(title: ''),
    );
  }
}

class Sendemadri extends StatefulWidget {
  const Sendemadri({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<Sendemadri> createState() => _SendemadriState();
}

class _SendemadriState extends State<Sendemadri> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/senmadri1.jpg', 'Cerro Mogoton', () {
                  // Acción del botón "Ver más" para Cerro Mogoton
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => sendemadri1()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/senmadri2.jpg', 'Cascadas de La Flor: Un oasis de frescura en Madriz', () {
                  // Acción del botón "Ver más" para Cascadas de La Flor
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => sendemadri2()),
                  );
                }),
