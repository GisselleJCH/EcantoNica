...
import 'package:barra/pages/lugares/rivas_senderismo.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadessenderismo_rivas(title: '',));
}

class actividadessenderismo_rivas extends StatelessWidget {
  const actividadessenderismo_rivas({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => rivas_senderismo(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/rivas6.jpg', 'Cerro de la Cruz', '/actividadUno'),
