...
import 'package:barra/pages/lugares/diriamba_deporte.dart';

void main() {
  runApp(const actividadesdeportes_diriamba(title: '',));
}

class actividadesdeportes_diriamba extends StatelessWidget {
  const actividadesdeportes_diriamba({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => diriamba_deporte(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/diriamba8.jpg', 'Campo Santa Cecilia', '/actividadUno'),
