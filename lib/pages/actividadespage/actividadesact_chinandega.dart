...
import 'package:barra/pages/lugares/chinandega_actividaddos.dart';
import 'package:barra/pages/lugares/chinandega_actividaduno.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesact_chinandega(title: '',));
}

class actividadesact_chinandega extends StatelessWidget {
  const actividadesact_chinandega({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => chinandega_actividaduno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => chinandega_actividaddos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/chi3.jpg', 'Volcán San Cristóbal', '/actividadUno'), // Ruta a la primera actividad
                const SizedBox(height: 20),
                buildContainer('assets/chi4.jpg', 'Reserva Natural Chocoyol-Hernández', '/actividadDos'), // Ruta a la segunda actividad
              ],
            ),
          ),
        ],
