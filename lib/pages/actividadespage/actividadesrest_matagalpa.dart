...
import 'package:barra/pages/lugares/matagalpa_restdos.dart';
import 'package:barra/pages/lugares/matagalpa_restuno.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadesrest_matagalpa(title: 'restmatagalpa',));
}

class actividadesrest_matagalpa extends StatelessWidget {
  const actividadesrest_matagalpa({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => matagalpa_restuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => matagalpa_restdos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/ma1.jpg', 'Mi Marisquería', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/ma2.jpg', 'Buffet Oasis', '/actividadDos'),
              ],
            ),
          ),
        ],
