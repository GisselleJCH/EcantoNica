import 'package:barra/pages/lugares/granada_restdos.dart';
import 'package:barra/pages/lugares/granada_restuno.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesrest_granada(title: 'restgranada',));
}

class actividadesrest_granada extends StatelessWidget {
  const actividadesrest_granada({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => granada_restuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => granada_restdos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/granada1.jpg', 'Restaurante El Zaguán', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/granada2.jpg', 'Bistro Estrada', '/actividadDos'),
              ],
            ),
          ),
        ],
