import 'package:barra/pages/lugares/leon_actividaddos.dart';
import 'package:barra/pages/lugares/leon_actividaduno.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesact_leon(title: '',));
}

class actividadesact_leon extends StatelessWidget {
  const actividadesact_leon({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => leon_actividaduno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => leon_actividaddos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/leon3.jpg', 'Parque Central de León', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/leon4.jpg', 'Jardín Botánico León', '/actividadDos'),
              ],
            ),
          ),
        ],
