import 'package:barra/pages/lugares/leon_deportes.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesdeportes_leon(title: '',));
}

class actividadesdeportes_leon extends StatelessWidget {
  const actividadesdeportes_leon({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => leon_deportes(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/leon9.jpg', 'Club Deportivo León', '/actividadUno'),
