...
import 'package:barra/pages/lugares/masaya_senderismodos.dart';
import 'package:barra/pages/lugares/masaya_senderismouno.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadessenderismo_masaya(title: '',));
}

class actividadessenderismo_masaya extends StatelessWidget {
  const actividadessenderismo_masaya({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => masaya_senderismouno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => masaya_senderismodos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/masaya5.jpg', 'Parque Volcán Masaya', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/masaya6.jpg', 'Sendero El Chocoyero', '/actividadDos'),
              ],
            ),
          ),
        ],
