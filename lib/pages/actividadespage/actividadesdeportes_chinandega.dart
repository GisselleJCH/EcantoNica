...
import 'package:barra/pages/lugares/chinandega_deporteuno.dart';
import 'package:barra/pages/lugares/chinandega_deportedos.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesdeportes_chinandega(title: '',));
}

class actividadesdeportes_chinandega extends StatelessWidget {
  const actividadesdeportes_chinandega({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/deporteUno': (context) => chinandega_deporteuno(), // Define la ruta para la primera actividad
        '/deporteDos': (context) => chinandega_deportedos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/chi9.jpg', 'Complejo Deportivo Enel', '/deporteUno'), // Ruta a la primera actividad
                const SizedBox(height: 20),
                buildContainer('assets/chi10.jpg', 'Estadio de Fútbol', '/deporteDos'),
              ],
            ),
          ),
        ],
