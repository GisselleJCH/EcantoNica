...
import 'package:barra/pages/lugares/resta1-boaco.dart';
import 'package:barra/pages/lugares/resta2-boaco.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Restaboaco(title: ''),
    );
  }
}

class Restaboaco extends StatefulWidget {
  const Restaboaco({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<Restaboaco> createState() => _RestaboacoState();
}

class _RestaboacoState extends State<Restaboaco> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/R1.jpg', 'Restaurante Doña Julia', () {
                  // Acción del botón "Ver más" para Restaurante Doña Julia
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => rboac1()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/R2.webp', 'Restaurante La Casona', () {
                  // Acción del botón "Ver más" para Restaurante La Casona
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => rboac2()),
                  );
                }),
              ],
            ),
