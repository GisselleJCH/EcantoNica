...
import 'package:barra/pages/lugares/chinandega_senderismodos.dart';
import 'package:barra/pages/lugares/chinandega_senderismouno.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadessenderismo_chinandega(title: '',));
}

class actividadessenderismo_chinandega extends StatelessWidget {
  const actividadessenderismo_chinandega({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: ''),
       routes: {
        '/actividadUno': (context) => chinandega_senderismouno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => chinandega_senderismodos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/chi7.jpg', 'Cerro El Chonco', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/chi8.jpg', 'Cascadas de Santa Rosa', '/actividadDos'),
              ],
            ),
          ),
        ],
