...
import 'package:barra/pages/lugares/matagalpa_actividaduno.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadesact_matagalpa(title: '',));
}

class actividadesact_matagalpa extends StatelessWidget {
  const actividadesact_matagalpa({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => matagalpa_actividaduno(), // Define la ruta para la primera actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/ma3.jpg', 'Reserva Natural Cerro Apó', '/actividadUno'),
