import 'package:barra/pages/lugares/granada_senderismodos.dart';
import 'package:barra/pages/lugares/granada_senderismouno.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadessenderismo_granada(title: '',));
}

class actividadessenderismo_granada extends StatelessWidget {
  const actividadessenderismo_granada({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => granada_senderismouno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => granada_senderismodos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/granada7.jpg', 'Lago Cocibolca', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/granada8.jpg', 'Mirador de Posintepe', '/actividadDos'),
              ],
            ),
          ),
        ],
