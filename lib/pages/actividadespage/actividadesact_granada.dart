import 'package:barra/pages/lugares/granada_actividaddos.dart';
import 'package:barra/pages/lugares/granada_actividaduno.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesact_granada(title: '',));
}

class actividadesact_granada extends StatelessWidget {
  const actividadesact_granada({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => granada_actividaduno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => granada_actividaddos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/granada3.jpg', 'Bicicleta - Andemos, Tours & Bikes', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/granada4.jpg', 'Paseo en Carruaje en Granada', '/actividadDos'),
              ],
            ),
          ),
        ],
