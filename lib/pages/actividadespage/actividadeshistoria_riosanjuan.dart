...
import 'package:barra/pages/lugares/his1-riosan.dart';
import 'package:barra/pages/lugares/his2-riosan.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const HistorioSan(title: ''),
    );
  }
}

class HistorioSan extends StatefulWidget {
  const HistorioSan({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<HistorioSan> createState() => _HistorioSanState();
}

class _HistorioSanState extends State<HistorioSan> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/hriosan1.jpg', 'Museo Regional de San Carlos', () {
                  // Acción del botón "Ver más" para Museo Regional de San Carlos
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>  hriosan1()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/hriosan2.jpg', 'Fuerte El Castillo', () {
                  // Acción del botón "Ver más" para Fuerte El Castillo
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>  hriosan2()),
                  );
                }),
              ],
            ),
