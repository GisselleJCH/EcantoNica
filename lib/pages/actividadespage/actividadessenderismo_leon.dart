import 'package:barra/pages/lugares/leon_senderismodos.dart';
import 'package:barra/pages/lugares/leon_senderismouno.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadessenderismo_leon(title: '',));
}

class actividadessenderismo_leon extends StatelessWidget {
  const actividadessenderismo_leon({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => leon_senderismouno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => leon_senderismodos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/leon6.jpg', 'Cerro Negro', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/leon7.jpg', 'Reserva Natural Península de León', '/actividadDos'),
              ],
            ),
          ),
        ],
