...
import 'package:barra/pages/lugares/parq1-madri.dart';
import 'package:barra/pages/lugares/parq2-madri.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Parmadri(title: ''),
    );
  }
}

class Parmadri extends StatefulWidget {
  const Parmadri({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<Parmadri> createState() => _ParmadriState();
}

class _ParmadriState extends State<Parmadri> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/parmadri1.jpg', 'Parque Central de Somoto', () {
                  // Acción del botón "Ver más" para Parque Central de Somoto
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>  parmadr1()),
                  );
                }),
                const SizedBox(height: 20),
                buildContainer('assets/parmadri2.jpg', 'Parque Rubén Darío', () {
                  // Acción del botón "Ver más" para Parque Rubén Darío
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => parmadr2()),
                  );
                }),
              ],
            ),
