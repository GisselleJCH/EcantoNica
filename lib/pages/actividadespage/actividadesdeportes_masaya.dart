import 'package:barra/pages/lugares/masaya_deportedos.dart';
import 'package:barra/pages/lugares/masaya_deporteuno.dart';
import 'package:flutter/material.dart';
import 'package:barra/pages/PageDepartamentos.dart';

void main() {
  runApp(const actividadesdeportes_masaya(title: '',));
}

class actividadesdeportes_masaya extends StatelessWidget {
  const actividadesdeportes_masaya({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => masaya_deporteuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => masaya_deportedos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/masaya7.jpg', 'Centro Deportivo Excelsior', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/masaya8.jpg', 'Sport Arena', '/actividadDos'),
              ],
            ),
          ),
        ],
