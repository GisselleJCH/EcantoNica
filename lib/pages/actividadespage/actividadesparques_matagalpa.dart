...
import 'package:barra/pages/lugares/matagalpa_parquedos.dart';
import 'package:barra/pages/lugares/matagalpa_parqueuno.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const actividadesparques_matagalpa(title: '',));
}

class actividadesparques_matagalpa extends StatelessWidget {
  const actividadesparques_matagalpa({Key? key, required String title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/actividadUno': (context) => matagalpa_parqueuno(), // Define la ruta para la primera actividad
        '/actividadDos': (context) => matagalpa_parquedos(), // Define la ruta para la segunda actividad
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: <Widget>[
                buildContainer('assets/ma4.jpg', 'Parque San Ramón', '/actividadUno'),
                const SizedBox(height: 20),
                buildContainer('assets/ma5.jpg', 'Parque Los Monos', '/actividadDos'),
              ],
            ),
          ),
        ],
